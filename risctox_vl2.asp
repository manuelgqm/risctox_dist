<% response.redirect "dn_risctox_vl2.asp" %>
<%
				...
				<div class="texto">
             				<% if len(numeracion)>3 then
			   	   	   	...
			   	   	   	set objRecordset = Server.CreateObject ("ADODB.Recordset")
              				     ...
              				     next
              				     response.write "<a href=risctox1.asp>Inicio</a>&nbsp;&gt;&nbsp;Límites de exposición profesional: Valores Límite Ambientales Cancerígenos</p>"
              				   else
              				     response.write "<p class=campo>&nbsp;</p>"
              			   end if %>
				
				<p class=titulo3>RISCTOX: Límites de exposición profesional: Valores Límite Ambientales Cancerígenos</p>

				<form name="form_buscar" action="risctox_vl2.asp">
				<table class="tabla3" width="90%" align="center">
				  <tr>
					<td class="subtitulo3" align="right">Buscador de sustancias con valores límite ambientales cancerígenos:&nbsp;</td>
...
<%				buscar = request("buscar")
				...
				sql = "SELECT RQ_SUSTANCIAS.NOMBRE, RQ_SUSTANCIAS_VL2.CAS, RQ_SUSTANCIAS_VL2.nombre as SUSTANCIA, RQ_SUSTANCIAS_VL2.vlaed1, RQ_SUSTANCIAS_VL2.vlaed2, RQ_SUSTANCIAS_VL2.c, RQ_SUSTANCIAS_VL2.m, RQ_SUSTANCIAS_VL2.notas "
				sql = sql & "FROM RQ_SUSTANCIAS RIGHT JOIN RQ_SUSTANCIAS_VL2 ON RQ_SUSTANCIAS.CAS = RQ_SUSTANCIAS_VL2.CAS "
				if buscar<>"" then sql = sql & "WHERE (RQ_SUSTANCIAS.nombre LIKE '%"&buscar&"%' OR RQ_SUSTANCIAS.sinonimos LIKE '%"&buscar&"%' OR RQ_SUSTANCIAS.cas LIKE '%"&buscar&"%' OR RQ_SUSTANCIAS.cee LIKE '%"&buscar&"%' OR RQ_SUSTANCIAS.rd LIKE '%"&buscar&"%') "
				...
				set objRecordset = Server.CreateObject ("ADODB.Recordset")
				  ...
				  <tr>
				  	<td class="subtitulo3" valign="top">
				  		<a href="risctox_vl2.asp?buscar=<%=buscar%>&ordenacion=RQ_SUSTANCIAS_VL2.nombre<%=texto_ord%>">Sustancias (<%=registros%>)</a>&nbsp;
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.nombre DESC" then response.write "<img src=imagenes/abajo.gif>" %>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.nombre" then response.write "<img src=imagenes/arriba.gif>" %>
				  	</td>
				  	<td class="subtitulo3" valign="top">
				  		<a href="risctox_vl2.asp?buscar=<%=buscar%>&ordenacion=RQ_SUSTANCIAS_VL2.cas<%=texto_ord%>">CAS</a>&nbsp;
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.cas DESC" then response.write "<img src=imagenes/abajo.gif>" %>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.cas" then response.write "<img src=imagenes/arriba.gif>" %>
				  	</td>
				  	<td class="subtitulo3" valign="top">
				  		<a href="risctox_vl2.asp?buscar=<%=buscar%>&ordenacion=RQ_SUSTANCIAS_VL2.vlaed1<%=texto_ord%>">VLA-ED</a>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.vlaed1 DESC" then response.write "<img src=imagenes/abajo.gif>" %>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.vlaed1" then response.write "<img src=imagenes/arriba.gif>" %>(ppm)
				  	</td>
				  	<td class="subtitulo3" valign="top">
				  		<a href="risctox_vl2.asp?buscar=<%=buscar%>&ordenacion=RQ_SUSTANCIAS_VL2.vlaed2<%=texto_ord%>">VLA-ED</a>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.vlaed2 DESC" then response.write "<img src=imagenes/abajo.gif>" %>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.vlaed2" then response.write "<img src=imagenes/arriba.gif>" %>(mg/m<sup>2</sup>)
				  	</td>
				  	<td class="subtitulo3" valign="top">
				  		<a href="risctox_vl2.asp?buscar=<%=buscar%>&ordenacion=RQ_SUSTANCIAS_VL2.c<%=texto_ord%>">C</a>&nbsp;
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.c DESC" then response.write "<img src=imagenes/abajo.gif>" %>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.c" then response.write "<img src=imagenes/arriba.gif>" %>
				  	</td>
				  	<td class="subtitulo3" valign="top">
				  		<a href="risctox_vl2.asp?buscar=<%=buscar%>&ordenacion=RQ_SUSTANCIAS_VL2.m<%=texto_ord%>">M</a>&nbsp;
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.m DESC" then response.write "<img src=imagenes/abajo.gif>" %>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.m" then response.write "<img src=imagenes/arriba.gif>" %>
				  	</td>
				  	<td class="subtitulo3" valign="top">
				  		<a href="risctox_vl2.asp?buscar=<%=buscar%>&ordenacion=RQ_SUSTANCIAS_VL2.notas<%=texto_ord%>">NOTAS</a>&nbsp;
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.notas DESC" then response.write "<img src=imagenes/abajo.gif>" %>
				  		<% if ordenacion="RQ_SUSTANCIAS_VL2.notas" then response.write "<img src=imagenes/arriba.gif>" %>
				  	</td>
				  </tr>
...
<%				if Clng(Session("pagina")) > 1 then %>
				<a href="risctox_vl2.asp?ordenacion=<%=ordenacion%>&buscar=<%=buscar%>&pag=<%=Clng(Session("pagina"))-1%>">anterior&nbsp;&lt;&lt;</a>&nbsp;&nbsp;&nbsp;
<%				end if %>
				Página&nbsp;<%=Session("pagina")%>&nbsp;de&nbsp;<%=objRecordset.Pagecount%>
<%				if Clng(Session("pagina")) < objRecordset.Pagecount then %>
				&nbsp;&nbsp;&nbsp;<a href="risctox_vl2.asp?ordenacion=<%=ordenacion%>&buscar=<%=buscar%>&pag=<%=Clng(Session("pagina"))+1%>">&gt;&gt;&nbsp;siguiente</a>
<%				end if %>
...
<%				end if %>				
				...
				<input type="hidden" name="campo5" value="c">
				<input type="hidden" name="campo6" value="m">
				...
				<input type="hidden" name="nombre5" value="C">
				<input type="hidden" name="nombre6" value="M">
				<input type="hidden" name="nombre7" value="NOTAS">
				
				<input type="hidden" name="sql" value="<%=sql%>">
				<input type="hidden" name="buscar" value="<%=buscar%>">
				<input type="hidden" name="titulo" value="Límites de exposición profesional: Valores Límite Ambientales Cancerígenos">
...
{	if (form_pag.pag_ir.value><%=objRecordset.Pagecount%>)
	...
	{ location.href='risctox_vl2.asp?ordenacion=<%=ordenacion%>&buscar=<%=buscar%>&pag='+form_pag.pag_ir.value; }
}
</script>
