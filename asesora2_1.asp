<%
	...
	if session("id_ecogente")="" then response.redirect "acceso.asp?idpagina=563"
	...
	idpagina = 563	'--- página Asistencia directa a solicitudes (sólo para registrar estadísticas)
	'----- Registrar la visita
...
<head>
<title>ECOinformas: servicio de asesoramiento del Observatorio medioambiental</title>
...
%>
			...
			<% end if %>
				...
				<div class="texto">
					...
					<p class="titulo2">Bienvenido(a) al servicio de asesoramiento del Observatorio medioambiental.</p>
					<p>Desde esta página puedes enviar cualquier consulta que tengas sobre el medio ambiente en tu trabajo. Nuestros asesores te responderán mediante un correo electrónico u otro medio de contacto que nos hayas dejado.<br><br>
					<b>Este servicio es gratuito, pero está reservado a trabajadores con las características que a continuación se detallan y que además residan en alguna de las siguientes Comunidades Autónomas: Aragón, Baleares, Cataluña, La Rioja, Madrid, Navarra o País Vasco:</b><br><br>
						<ul><li class=vineta><b>Trabajadores activos de PYME</b>, cualquiera que sea su categoría profesional.</li><br>
						<li class=vineta><b>Profesionales autónomos</b>, siempre relacionados con el sector medioambiental.</li><br>
						<li class=vineta><b>Trabajadores activos en grandes empresas en España</b>, siempre que pertenezcan a uno de los siguientes colectivos:</li><br>
						&nbsp;&nbsp;&nbsp;&nbsp;<img src=imagenes/vineta.gif>&nbsp;&nbsp;Mujeres<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<img src=imagenes/vineta.gif>&nbsp;&nbsp;Trabajadores mayores de 45 años<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<img src=imagenes/vineta.gif>&nbsp;&nbsp;Trabajadores de baja cualificación<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<img src=imagenes/vineta.gif>&nbsp;&nbsp;Discapacitados<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<img src=imagenes/vineta.gif>&nbsp;&nbsp;Inmigrantes<br>
					</p>
					<p>Para realizar tu consulta, escribe aquí el texto y envíalo:</p>
					<form name="asesora2" action="asesora2_2.asp" method="POST">
					
					<table align=center>
					<tr><td>
					<textarea name="consulta" cols="60" rows="20" class="campo"></textarea>
					</td><td>
					<input type="button" class="boton" value="ENVIAR" onclick="enviar()"><br><br>
