...
' PUBLIC METHODS'
	...
	Public function obtainMedioAmbienteFields(id_sustancia, connection)
		dim fields : set fields = findMedioAmbienteFields(id_sustancia, connection)
		Me.fields = fields
	end function

	Public function obtainCancerOtrasFields(id_sustancia, connection)
		dim fields : set fields = findCancerOtrasFields(id_sustancia, connection)
		Me.fields = fields
	end function

	Public function obtainEnfermedadesFields(id_sustancia, connection)
		dim fields : set fields = findEnfermedadesFields(id_sustancia, connection)
		Me.fields = fields
	end function
