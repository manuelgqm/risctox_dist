...
function get_string_tablas( opcion )
	...
	select case( opcion )
		...
		case "autorizacion_reach": 	'autorización reach
		...
		'SPL (16/06/2014)
		case "mpmb":
			sqls = sqls & "(mpmb=1) OR (" & monta_condicion_grupo( "asoc_mpmb" ) & ")"
    ...
    'case else:
      'sqls = "SELECT TOP 100 id FROM dn_risc_sustancias WHERE 1=0"
...
function get_string_codicion( opcion )
	...
	select case( opcion )
		...
		case "cym3": 'la condicion simplemente es que exista la fila, pero ya que estamos, comprobamos que no este vacía
			sqls = sqls & " (not(dn_risc_sustancias_cancer_otras.fuente like '%ACGIH%' and " &_
										"(dn_risc_sustancias_cancer_otras.categoria_cancer_otras like '%G-A5%' or " &_
										"dn_risc_sustancias_cancer_otras.categoria_cancer_otras like '%G-A4%' ) ) or " &_
										"(dn_risc_sustancias_cancer_otras.categoria_cancer_otras is null))  and " &_ 
										"( ((dn_risc_sustancias_cancer_otras.categoria_cancer_otras<>'')) OR " &_ 
										"(" & monta_condicion_grupo( "asoc_cancer_otras" ) & ") )"
      ...
      sql = "SELECT TOP 100 id FROM dn_risc_sustancias WHERE 1=1"
		...
		case "cancerigenos_rd":
			campos = "sus.clasificacion_1, sus.clasificacion_2, sus.clasificacion_3, sus.clasificacion_4, sus.clasificacion_5, sus.clasificacion_6, sus.clasificacion_7, sus.clasificacion_8, sus.clasificacion_9, sus.clasificacion_10, sus.clasificacion_11, sus.clasificacion_12, sus.clasificacion_13, sus.clasificacion_14, sus.clasificacion_15"
			frases = "R45, R49, R40"
			sqls = sqls & "( " & monta_condicion(campos, frases) & " OR (" & monta_condicion_grupo( "asoc_cancer_rd" ) & ") )"
			
		case "mutagenos_all":
			campos = "sus.clasificacion_rd1272_1, sus.clasificacion_rd1272_2, sus.clasificacion_rd1272_3, sus.clasificacion_rd1272_4, sus.clasificacion_rd1272_5, sus.clasificacion_rd1272_6, sus.clasificacion_rd1272_7, sus.clasificacion_rd1272_8, sus.clasificacion_rd1272_9, sus.clasificacion_rd1272_10, sus.clasificacion_rd1272_11, sus.clasificacion_rd1272_12, sus.clasificacion_rd1272_13, sus.clasificacion_rd1272_14, sus.clasificacion_rd1272_15, "
			campos = campos & "sus.conc_rd1272_1, sus.conc_rd1272_2, sus.conc_rd1272_3, sus.conc_rd1272_4, sus.conc_rd1272_5, sus.conc_rd1272_6, sus.conc_rd1272_7, sus.conc_rd1272_8, sus.conc_rd1272_9, sus.conc_rd1272_10, sus.conc_rd1272_11, sus.conc_rd1272_12, sus.conc_rd1272_13, sus.conc_rd1272_14, sus.conc_rd1272_15, "
			campos = campos & "sus.eti_conc_rd1272_1, sus.eti_conc_rd1272_2, sus.eti_conc_rd1272_3, sus.eti_conc_rd1272_4, sus.eti_conc_rd1272_5, sus.eti_conc_rd1272_6, sus.eti_conc_rd1272_7, sus.eti_conc_rd1272_8, sus.eti_conc_rd1272_9, sus.eti_conc_rd1272_10, sus.eti_conc_rd1272_11, sus.eti_conc_rd1272_12, sus.eti_conc_rd1272_13, sus.eti_conc_rd1272_14, sus.eti_conc_rd1272_15"
			frases = "H340, H341"
			sqls = sqls & "( " & monta_condicion(campos, frases) & " )"
			
			campos = "sus.clasificacion_1, sus.clasificacion_2, sus.clasificacion_3, sus.clasificacion_4, sus.clasificacion_5, sus.clasificacion_6, sus.clasificacion_7, sus.clasificacion_8, sus.clasificacion_9, sus.clasificacion_10, sus.clasificacion_11, sus.clasificacion_12, sus.clasificacion_13, sus.clasificacion_14, sus.clasificacion_15"
			frases = "R46, R68"
			sqls = sqls & " OR ( " & monta_condicion(campos, frases) & " )"
...
function get_sqlstr_listas( lista )
	dim sqls, lista_alias
	
	if ( lista = "1" ) then
		sqls = "select distinct sus.id, sus.nombre from dn_risc_sustancias as sus " &_
		...
		sqls = "select distinct sus.id, sus.nombre from dn_risc_sustancias as sus "
	end if
	
	if lista = "cancerigenos_all" then 
		lista_alias = "'cancerigenos', 'cym2', 'cym3', 'mama'"
	else
		lista_alias = "'" & lista & "'"
	end if
	
	sqls = sqls & "INNER JOIN (SELECT distinct sustancia_id FROM risctox_sustancias_listas AS sl " &_
									"INNER JOIN risctox_listas AS l " &_
										"ON sl.lista_id = l.id " &_
									"WHERE alias IN (" & lista_alias & ") ) AS SL " &_
								" ON sus.id = SL.sustancia_id"
	
	get_sqlstr_listas = sqls
end function
%>