...
function get_string_tablas( opcion )
	...
	select case( opcion )
		case "1":
		' Buscador de alternativas. Muestra las sustancias asociadas como toxicas a un uso para el que hay alternativas no toxicas, y tambi�n sustancias asociadas a ficheros de alternativas
		...
		case "tpr": 	'T�xicos para la reproducci�n
		...
		case "corap"
			sqls = sqls & " INNER JOIN ist_risc_sustancias_corap ON " &_
			"(sus.id = ist_risc_sustancias_corap.id_sustancia)"
...
'			sqls = sqls & "(sus.num_cas='87-68-3' or sus.num_cas='133-49-3' or sus.num_cas='75-74-1') OR ("&monta_condicion_grupo("asoc_mpmb")&")"
		...
		case "negra": 'Lista negra
			...
			'sqls = sqls & " and (not(caoc.fuente like '%ACGIH%' and caoc.categoria_cancer_otras like '%G-A5%' ) or (caoc.categoria_cancer_otras is null))"
			sqls = sqls & " and not (sus.clasificacion_1 like '%67%' or sus.clasificacion_2 like '%67%' or sus.clasificacion_3 like '%67%' or sus.clasificacion_4 like '%67%' or sus.clasificacion_5 like '%67%' or sus.clasificacion_6 like '%67%' or sus.clasificacion_7 like '%67%' or sus.clasificacion_8 like '%67%' or sus.clasificacion_9 like '%67%' or sus.clasificacion_10 like '%67%' or sus.clasificacion_11 like '%67%' or sus.clasificacion_12 like '%67%' or sus.clasificacion_13 like '%67%' or sus.clasificacion_14 like '%67%' or sus.clasificacion_15 like '%67%')))" &_
			 " and sus.id not in (select id_sustancia from dn_risc_sustancias_cancer_otras where categoria_cancer_otras like '%G-A4%') "
