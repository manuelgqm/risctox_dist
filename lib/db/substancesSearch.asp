...
function obtainListTitle(listName)
	...
	select case listName:
		case "cym2": result = "Sustancias cancer&iacute;genas o mut&aacute;genas (seg&uacute;n RD IARC)"
		case "cym3": result = "Sustancias cancer&iacute;genas o mut&aacute;genas (seg&uacute;n otras fuentes)"
		case "mama": result = "Sustancias que provocan c&aacute;ncer de mama(seg&uacute;n SSI)"
		case "tpr": result = "T&oacute;xicos para la reproducci&oacute;n"
		case "dis": result = "Disruptores endocrinos"
		case "neu": result = "Neurot&oacute;xicos"
		case "oto": result = "Otot&oacute;xicos"
		case "sen": result = "Sensibilizantes"
		case "sen_reach": result = "Al&eacute;rgenos REACH"
		case "pyb": result = "T&oacute;xicas, persistentes y bioacumulativas"
		case "mpmb": result = "Muy t&oacute;xicas, persistentes y bioacumulativas"
		case "tac": result = "Directiva de aguas"
		case "tac2": result = "Peligrosas agua Alemania"
		case "dat": result = "Capa de Ozono"
		case "dat2": result = "Cambio clim&aacute;tico"
		case "dat3": result = "Calidad del aire"
		case "cos": result = "Contaminantes de suelos (seg&uacute;n RD 9/2005)"
		case "cop": result = "Contaminantes Org&aacute;nicos Persistentes (COP's)"
		case "vl1": result = "Valores L&iacute;mite Ambientales"
		case "vl2": result = "Valores L&iacute;mite Ambientales Cancer&iacute;genos"
		case "vl3": result = "Valores L&iacute;mite Biol&oacute;gicos"
		case "enf": result = "Enfermedades profesionales"
		case "res": result = "Residuos peligrosos"
		case "ver": result = "Vertidos"
		case "emi": result = "Emisiones"
		case "cov": result = "COV"
		case "ep1": result = "PRTR (Agua)"
		case "ep2": result = "PRTR (Aire)"
		case "ep3": result = "PRTR (Suelo)"
		case "acm": result = "Accidentes graves"
		case "rest": result = "Sustancias restringidas REACH"
		case "candidatas_reach": result = "Sustancias candidatas REACH"
		case "autorizacion_reach": result = "Sustancias sujetas a autorizaci&oacute;n de REACH"
		case "pro_emb": result = "Prohibidas para trabajadoras embarazadas"
		case "pro_lac": result = "Prohibidas para trabajadoras lactantes"
		case "biocidas_prohibidas": result = "Sustancias Biocidas prohibidas"
		case "biocidas_autorizadas": result = "Sustancias Biocidas autorizadas"
		case "pesticidas_autorizadas": result = "Sustancias pesticidas autorizadas"
		case "pesticidas_prohibidas": result = "Sustancias Pesticidas prohibidas"
		case "corap": result = "Sustancias bajo evaluaci&oacute;n. CoRAP"
	end select
