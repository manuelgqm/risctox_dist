...
function obtainListTitle(listName)
	...
	select case listName:
		case "cym": result = "Sustancias cancerígenas o mutágenas (según R. 1272/2008)"
		case "cym2": result = "Sustancias cancerígenas o mutágenas (según RD IARC)"
		case "cym3": result = "Sustancias cancerígenas o mutágenas (según otras fuentes)"
		case "mama": result = "Sustancias que provocan cáncer de mama(según SSI)"
		case "tpr": result = "Tóxicos para la reproducción"
		case "dis": result = "Disruptores endocrinos"
		case "neu": result = "Neurotóxicos"
		case "oto": result = "Ototóxicos"
		case "sen": result = "Sensibilizantes"
		case "sen_reach": result = "Alérgenos REACH"
		case "pyb": result = "Tóxicas, persistentes y bioacumulativas"
		case "mpmb": result = "Muy tóxicas, persistentes y bioacumulativas"
		case "tac": result = "Directiva de aguas"
		case "tac2": result = "Peligrosas agua Alemania"
		case "dat": result = "Capa de Ozono"
		case "dat2": result = "Cambio climático"
		case "dat3": result = "Calidad del aire"
		case "cos": result = "Contaminantes de suelos (según RD 9/2005)"
		case "cop": result = "Contaminantes Orgánicos Persistentes (COP's)"
		case "vl1": result = "Valores Límite Ambientales"
		case "vl2": result = "Valores Límite Ambientales Cancerígenos"
		case "vl3": result = "Valores Límite Biológicos"
		...
		case "autorizacion_reach": result = "Sustancias sujetas a autorización de REACH"
		...
		case "corap": result = "Sustancias bajo evaluación. CoRAP"
	end select
