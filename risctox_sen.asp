<% response.redirect "dn_risctox_sen.asp" %>
<%
	...
	if session("id_ecogente")="" then response.redirect "acceso.asp?pagina_esp=risctox_sen.asp"
...
<%				buscar = request("buscar")
				...
				for i=1 to 11
					sql = sql &" OR clasific"&i&" LIKE '%42%' OR clasific"&i&" LIKE '%43%' " 
				next
				...
				set objRecordset = Server.CreateObject ("ADODB.Recordset")
				  ...
				  <tr>
				  	...
				  	<td class="subtitulo3">
				  		<a href="risctox_sen.asp?buscar=<%=buscar%>&ordenacion=rd<%=texto_ord%>">RD 363/1995</a>&nbsp;
