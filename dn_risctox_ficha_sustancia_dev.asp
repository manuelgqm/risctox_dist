...
<!--#include file="dn_conexion_dev.asp"-->
<!--#include file="dn_funciones_comunes_dev.asp"-->
...
if(objRst.eof) then
	...
	frases_h_danesa = trim( objRst( "frases_h" ) )
...
Set sustancia = get_sustancia_attributes( id_sustancia )
...
esta_en_lista_cancer_danesa_h = esta_en_lista_cancer_danesa_h or esta_en_lista( "cancer_danesa_h", id_sustancia )
...
esta_en_lista_mutageno_danesa_h = esta_en_lista_mutageno_danesa_h or esta_en_lista ("mutageno_danesa_h", id_sustancia)
...
esta_en_lista_tpr_danesa_h = esta_en_lista_tpr_danesa_h or esta_en_lista ("tpr_danesa_h", id_sustancia)
...
esta_en_lista_neurotoxico_danesa_h = esta_en_lista_neurotoxico_danesa_h or  esta_en_lista ("neurotoxico_danesa_h", id_sustancia)
...
esta_en_lista_neurotoxico = esta_en_lista_neurotoxico or esta_en_lista_neurotoxico_rd OR esta_en_lista_neurotoxico_danesa or esta_en_lista_neurotoxico_danesa_h OR esta_en_lista_neurotoxico_nivel OR esta_en_lista ("neurotoxico", id_sustancia)
...
esta_en_lista_sensibilizante_danesa_h = esta_en_lista_sensibilizante_danesa_h or esta_en_lista ("sensibilizante_danesa_h", id_sustancia)
...
if (frases_h = "") and (frases_h_danesa <> "") then
  frases_h_danesa_mostradas = true
else
  frases_h_danesa_mostradas = false
end if
	...
	<tr><td>
		<table id="secc-clasificacion-363" style="display:none">
			<tr>
		        ...
		        if frases_h_danesa_mostradas then
		          ap2_clasificacion_frases_h_danesa()
		        elseif frases_r_danesa_mostradas then
...
sub ap2_clasificacion_frases_r_danesa()
	...
	' Montamos frases R
	aux = monta_frases_rh_danesa(frases_r_danesa, "R")
...
sub ap2_clasificacion_frases_h_danesa()
	' Muestra las frases R danesas

	aux = monta_frases_rh_danesa(frases_h_danesa, "H")

	if (aux <> "") then
%>
	<p id="ap2_clasificacion_frases_h_danesa_titulo" class="ficha_titulo_2"><a onclick=window.open('ver_definicion.asp?id=<%=dame_id_definicion("Frases H según la lista danesa de la EPA")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> Frases H según clasificación de la EPA danesa</p>
<%
		bucle_frases "h", aux
	end if
end sub
...
sub ap2_clasificacion_lista_negra()
	...
	if (esta_en_lista_cancer_rd or esta_en_lista_cancer_rd_h or esta_en_lista_cancer_danesa or esta_en_lista_cancer_danesa_h or esta_en_lista_cancer_iarc_excepto_grupo_3 or esta_en_lista_cancer_otras_excepto_grupo_4 or esta_en_lista_de or (esta_en_lista_neurotoxico and (instr(frases_r,"R67")=0)) or  esta_en_lista_tpb or esta_en_lista_sensibilizante or esta_en_lista_sensibilizante_danesa or esta_en_lista_sensibilizante_danesa_h or esta_en_lista_sensibilizante_reach or esta_en_lista_tpr or esta_en_lista_tpr_danesa or esta_en_lista_tpr_danesa_h or esta_en_lista_mutageno_rd or esta_en_lista_mutageno_danesa or esta_en_lista_mutageno_danesa_h or esta_en_lista_cancer_mama or esta_en_lista_cop) or (instr(frases_r,"R33")<>0) or (instr(frases_r,"R53")<>0) or (instr(frases_r,"R50-53")<>0) or (instr(frases_r,"R51-53")<>0) or (instr(frases_r,"R52-53")<>0) or (instr(frases_r,"R58")<>0) then
    ...
    ' OK, continuamos...
		...
		if (esta_en_lista_cancer_rd or esta_en_lista_cancer_rd_h or esta_en_lista_cancer_danesa or esta_en_lista_cancer_danesa_h or esta_en_lista_cancer_iarc_excepto_grupo_3 or esta_en_lista_cancer_otras_excepto_grupo_4 or esta_en_lista_cancer_mama) then
			if (razones = "") then
				razones = "cancerígena"
			else
		...
		if (esta_en_lista_mutageno_rd or esta_en_lista_mutageno_danesa or esta_en_lista_mutageno_danesa_h) then
			if (razones = "") then
				razones = "mutágena"
			else
		...
		if (esta_en_lista_sensibilizante or esta_en_lista_sensibilizante_danesa or esta_en_lista_sensibilizante_danesa_h or esta_en_lista_sensibilizante_reach) then
			if (razones = "") then
		...
		if (esta_en_lista_tpr or esta_en_lista_tpr_danesa or esta_en_lista_tpr_danesa_h) then
			if (razones = "") then
...
sub ap3_riesgos()
	...
	if inStr( sustancia( "categorias" ), "riesgos_salud" ) then
	
	' esta_en_lista_cancer_rd or esta_en_lista_cancer_rd_h or esta_en_lista_cancer_danesa or esta_en_lista_cancer_danesa_h or esta_en_lista_cancer_iarc or esta_en_lista_cancer_otras or esta_en_lista_cancer_mama or esta_en_lista_de or esta_en_lista_neurotoxico or efecto_neurotoxico="OTOTÓXICO" or esta_en_lista_sensibilizante or esta_en_lista_sensibilizante_reach or esta_en_lista_sensibilizante_danesa or esta_en_lista_sensibilizante_danesa_h or esta_en_lista_tpr or esta_en_lista_tpr_danesa or esta_en_lista_tpr_danesa_h or esta_en_lista_eepp or esta_en_lista_mutageno_rd or esta_en_lista_mutageno_danesa or esta_en_lista_mutageno_danesa_h or esta_en_lista_salud or esta_en_lista_prohibidas_embarazadas or esta_en_lista_prohibidas_lactantes or comentarios_sl <> ""
...
<%
		if (esta_en_lista_cancer_rd or esta_en_lista_cancer_rd_h or esta_en_lista_cancer_danesa_h or esta_en_lista_cancer_iarc or esta_en_lista_cancer_otras or esta_en_lista_cancer_mama) then ap3_riesgos_tabla("Cancerígeno") end if
		'response.write esta_en_lista_mutageno_rd & esta_en_lista_mutageno_danesa
		if (esta_en_lista_mutageno_rd or esta_en_lista_mutageno_danesa or esta_en_lista_mutageno_danesa_h ) then ap3_riesgos_tabla("Mutágeno") end if
		...
		if esta_en_lista_sensibilizante or esta_en_lista_sensibilizante_danesa or esta_en_lista_sensibilizante_danesa_h or esta_en_lista_sensibilizante_reach then ap3_riesgos_tabla("Sensibilizante") end if
		'if esta_en_lista_sensibilizante_reach then ap3_riesgos_tabla("Sensibilizante para REACH") end if
		if esta_en_lista_tpr or esta_en_lista_tpr_danesa or esta_en_lista_tpr_danesa_h then ap3_riesgos_tabla("Tóxico para la reproducción") end if
...
<%
				...
				' Lista danesa ---------------------------------------------------------------
					if (esta_en_lista_cancer_danesa_h) then	%>
					<fieldset>
						<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_h_danesa_cancer", "frases H", "subtitulo3" %> en la clasificación de la EPA danesa <a onclick=window.open('ver_definicion.asp?id=<%=dame_id_definicion("EPA Danesa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>.</strong></legend>
						<blockquote>
						<%
						nivel_cancerigeno_danesa = dame_nivel_cancerigeno_danesa( frases_h_danesa )
		...
		%>
		        ...
		        <% ap2_clasificacion_frases_r_danesa() %>
						...
						<div id="frases_h_danesa_cancer" style="display:none"><br />
		        <% ap2_clasificacion_frases_h_danesa() %>
		        </div>
...
<%
      ...
      ' MUTAGENO DANESA -------------------------------------------------------------
			if esta_en_lista_mutageno_danesa_h then %>
				<fieldset>
					<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_h_danesa_mutageno", "frases H", "subtitulo3" %> en la clasificación de la EPA danesa <a onclick=window.open('ver_definicion.asp?id=<%=dame_id_definicion("EPA Danesa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>.</strong></legend>
					<blockquote>
					<%
						nivel_mutageno_danesa_h = dame_nivel_mutageno_danesa_h()
						if (nivel_mutageno_danesa_h <> "") then
						response.write "<br /><strong>Nivel mutágeno:</strong> " & nivel_mutageno_danesa_h
					%>
						 <a onclick=window.open('ver_definicion.asp?id=<%=dame_id_definicion("RDM"&nivel_mutageno_danesa_h)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
					<%
						end if
					%>

					<div id="frases_h_danesa_mutageno" style="display:none"><br />
					<% ap2_clasificacion_frases_h_danesa() %>
					</div>
			...
			<% elseif (esta_en_lista_mutageno_danesa) then %>
				<fieldset>
...
<%
        ...
        if esta_en_lista_neurotoxico_rd or esta_en_lista_neurotoxico_danesa or esta_en_lista_neurotoxico_danesa_h then
        ...
        if esta_en_lista_neurotoxico_danesa then
          if (fuente_neurotoxico = "") or (IsNull(fuente_neurotoxico)) then
            ...
            fuente_neurotoxico = fuente_neurotoxico & ",EPA-R67"
				...
				if esta_en_lista_neurotoxico_danesa_h then
          if (fuente_neurotoxico = "") or (IsNull(fuente_neurotoxico)) then
...
<%
		...
		case "Sensibilizante":
			  ...
			  if esta_en_lista_sensibilizante_reach then
				...
				if esta_en_lista_sensibilizante_danesa_h then %>
					<li class='subtitulo3'>Sensibilizante según <% plegador_texto "frases_h_danesa_sensibilizante", "frases H", "subtitulo3" %> en la clasificación de la EPA danesa <a onclick=window.open('ver_definicion.asp?id=<%=dame_id_definicion("EPA Danesa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></li>
		      <%


		      %>
		        <div id="frases_h_danesa_sensibilizante" style="display:none"><br />
		        <blockquote>
		        <% ap2_clasificacion_frases_h_danesa() %>
		        </blockquote>
		        </div>
		      <%
		    elseif esta_en_lista_sensibilizante_danesa then
		      %>
	...
	<%
	      ...
	      ' TPR SEGUN LISTA DANESA ---------------------------------------------------
				if esta_en_lista_tpr_danesa_h then %>
					<fieldset>
	  				<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_h_danesa_tpr", "frases H", "subtitulo3" %> en la clasificación de la EPA danesa <a onclick=window.open('ver_definicion.asp?id=<%=dame_id_definicion("EPA Danesa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></strong></legend>
	<%
	  			nivel_reproduccion_danesa_h = dame_nivel_reproduccion_danesa_h()
	  			if (nivel_reproduccion_danesa_h <> "") then
				  %>
	  				<blockquote>
	  					<strong>Categoría:</strong> <%=nivel_reproduccion_danesa_h%>
	  				  <a onclick=window.open('ver_definicion.asp?id=<%=dame_id_definicion("RDR"&nivel_reproduccion_danesa_h)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
	  					</blockquote>
	  			<%
	  			end if
	%>
	        <div id="frases_h_danesa_tpr" style="display:none"><br />
	        <blockquote>
	        <% ap2_clasificacion_frases_h_danesa() %>
	        </blockquote>
	        </div>
	      ...
	      <% elseif (esta_en_lista_tpr_danesa) then %>
	    			<fieldset>
...
function dame_nivel_cancerigeno_danesa( frases )
	' Buscamos la primera aparicion de "Carc"
	posicion = instr(1,frases, "Carc")

	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_cancerigeno_danesa = mid(frases, posicion+4, 1)
	else
...
function dame_nivel_mutageno_danesa_h()
	' Buscamos la primera aparicion de "Muta"
	posicion = instr(1,frases_h_danesa, "Muta")
	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_mutageno_danesa_h = mid(frases_h_danesa, posicion + 4, 1)
	else
		dame_nivel_mutageno_danesa_h = ""
	end if
end function
...
function dame_nivel_reproduccion_danesa()
	' Buscamos la primera aparicion de "Repr.Cat."
	posicion = instr(1,frases_r_danesa, "Repr.Cat.")

	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_reproduccion_danesa = mid(frases_r_danesa, posicion+9, 1)
	else
		dame_nivel_reproduccion_danesa = ""
	end if
end function

function dame_nivel_reproduccion_danesa_h()
	' Buscamos la primera aparicion de "Repr.Cat."
	posicion = instr(1, frases_h_danesa, "Repr")
	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_reproduccion_danesa_h = mid(frases_h_danesa, posicion + 4, 1)
	else
		dame_nivel_reproduccion_danesa_h = ""
	end if
end function
