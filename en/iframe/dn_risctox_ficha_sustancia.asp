...
<%
'----- Registrar la visita
	idpagina = 627	'--- p�gina Resultado de la b�squeda, s�lo para registrar estad�sticas
...
'dn_risc_sustancias_neuro_disruptor.efecto_neurotoxico='OTOT�XICO'
...
esta_en_lista_prohibidas_embarazadas = false 'se elimina de la ficha en la versi�n en ingl�s
esta_en_lista_prohibidas_lactantes = false 'se elimina de la ficha en la versi�n en ingl�s
...
<div id="ficha">
	...
	<table width="100%" cellpadding=5>
		<tr>
			<td class="subtitulo3">
				<img src="imagenes/info_logo.gif" alt="Substance identification" height="32" style="margin-right: 6px;" />Substance identification
			</td>
			<td align="right">
	...
	<div style="height:3pt"></div>
		...
		<!-- Valores l�mite -->
		<% 'ap2_clasificacion_vl("secc-vla") 'La eliminamos en la versi�n inglesa%>
...
<input type="button" name="volver" class="boton2" value="New search" onClick="window.location='dn_risctox_buscador.asp';">
	...
	<p class="texto" style="padding-left: 5px; padding-right: 5px;color:#999; text-align: center;">This web has been developed by <a href="http://www.spl-ssi.com" style="color:#999;" target="_blank">SPL Sistemas de Informaci&oacute;n</a></p>
...
sub ap1_identificacion()
	' Para obtener nombre y sin�nimos, todo se extrae del nombre en ingl�s.
...
%>
  ...
  <tr>
		<td class="celdaabajo" colspan="2" align="center">
			<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo2" align="left"><a onclick=window.open('ver_definicion.asp?id=87','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> CLASSIFICATION AND LABELLING (67/548/EEC)
...
%>
  ...
  <tr>
		<td class="celdaabajo" colspan="2" align="center">
			<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo2" align="left"><a onclick=window.open('ver_definicion.asp?id=280','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> CLASSIFICATION AND LABELLING (Regulation 1272/2008)
...
sub muestra_clasificacion(numero, clasificacion)
	if (len(trim(clasificacion))>0) then
		' El formato de la clasificacion es C�digo - Categoria: Frase H
...
<%
			...
			' Para ver definici�n de los *
 			frase = buscaDefinicionAsteriscos(frase)

 			' Las frases H??? son Gases a presi�n. Cambio solicitado por Tatiana en abril 2012
 			if (frase="H???") then
%>
...
sub bucle_frases(tipo, byval frases)
		' Pasandole las frases R o H separadas por comas, muestra cada una junto a su descripci�n
...
sub bucle_categorias_peligro_rd1272(byval frases)
		' Pasandole las frases separadas por guión, muestra cada una junto a su descripci�n
		array_frases = split(frases, ";")
...
%>
		<p id="ap2_clasificacion_lista_negra_titulo" class="subtitulo3">&nbsp;
			<p id="ap2_clasificacion_lista_negra_titulo" class="subtitulo3">&nbsp;
			<img src="imagenes/icono_atencion_20.png" align="absmiddle" /> 
			<a onclick="window.open('ver_definicion.asp?id=<%=dame_id_definicion("Lista negra")%>','def','width=300,height=200,scrollbars=yes,resizable=yes')" style="cursor:pointer"><img src="imagenes/ayuda.gif" width="14" height="14" align="absmiddle" border="0" /></a> Substance included in the List of Substances of concern for Trade Unions<% plegador "secc-listanegra", "img-listanegra" %>
		</p>
		<p id="secc-listanegra" class="texto" style="display:none">
			This substance is included in the List of Substances of concern for Trade Unions for the following reasons:<br/><%=razones%>
		</p>
...
%>
		...
		<table width="100%" cellpadding=5>
			<tr>
				<td class="subtitulo3">
					<img src="imagenes/ico_danos_sl.gif" alt="health effects" height="32" style="margin-right: 6px;" />health effects
				</td>
				<td align="right">
					<a href="#"><img src="imagenes/subir.gif" border=0 alt=subir></a>
				</td>
				...
				<tr>
					<td class="celdaabajo" colspan="2" align="center">
						<table cellpadding=0 cellspacing=0 width="100%" border="0">
							<tr>
								<td width="100%" class="titulo2" align="left">
...
<% ' MEDIO AMBIENTE %>
<%
if (esta_en_lista_tpb or esta_en_lista_directiva_aguas or esta_en_lista_alemana or esta_en_lista_ozono or esta_en_lista_clima or esta_en_lista_aire or esta_en_lista_cop or comentarios_medio_ambiente <>"" or esta_en_lista_suelos) then %>
		...
		<table width="100%" cellpadding=5>
			<tr>
				<td class="subtitulo3">
					<img src="imagenes/ico_danos_ma.gif" align="absmiddle" alt="Enviromental effects" style="margin-right: 3px" />Enviromental effects
				</td>
				<td align="right">
					<a href="#"><img src="imagenes/subir.gif" border=0 alt=subir></a>
				</td>
...
function traduceRiesgo(riesgo)
	...
	s = replace(s, "Sensibilizante para REACH","Sensitising for REACH")
	...
	s = replace(s, "Contaminante del aire","Air pollutants")
	s = replace(s, "Contaminante Orgánico Persistente (COP)","Persistent Organic Pollutants (POPs)")
	s = replace(s, "Residuos Peligrosos","Hazardous wastes")
	...
	s = replace(s, "Sustancia candidata REACH","REACH candidate substance")
	s = replace(s, "Sustancia REACH sujeta a autorización","Substance under REACH authorisation")
	s = replace(s, "Sustancia biocida autorizada","Restricted biocide substance")
	s = replace(s, "Sustancia biocida prohibida","Banned biocide substance")
	s = replace(s, "Sustancia pesticida autorizada","Restricted pesticide substance")
...
%>
	<table class="ficharisctox" width="90%" align="center" border="0" cellpadding="4" cellspacing="0">
   	<tr>
			<td class="celdaabajo" colspan="2" align="center">
				<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo2" align="left"><% ap3_riesgos_tabla_ayuda(tipo) %><%=traduceRiesgo(tipo)%>
...
<%
    ...
    According to <a href="http://www.istas.net/risctox/en/iframe/abreenlace.asp?idenlace=2940" target="_blank">Spanish RD 9/2005</a>
...
<%
				...
				' Tatiana - 01/8/2012 - Las categor�as sustituir 1 por 1A, 2 por 1B y 3 por 2.
...
<%
		...
		case "Sensibilizante":
			  ...
			  if esta_en_lista_sensibilizante_reach then
		        response.write "<li class='subtitulo3'>REACH allergen &nbsp;<a href='http://www.istas.net/risctox/en/iframe/abreenlace.asp?idenlace=6340' target='_blank'>View document</a></li>"
		      end if
...
%>
				<tr>
					<td class="subtitulo3" colspan="2">According to <a href="http://ec.europa.eu/environment/water/water-framework/index_en.html" target="_blank">Water Directive</a>, and subsequents <a href="http://www.istas.net/risctox/en/iframe/abreenlace.asp?idenlace=6323">amendments</a></td>
				</tr>
<%
			end if
...
%>
				<tr>
					<td class="subtitulo3" colspan="2">Possible priority substance according to <a href="http://ec.europa.eu/environment/water/water-framework/index_en.html" target="_blank">Water Directive</a>, and subsequents <a href="http://www.istas.net/risctox/en/iframe/abreenlace.asp?idenlace=6323">amendments</a></td>
				</tr>
<%
			end if
...
%>
				<tr>
					<td class="subtitulo3" colspan="2">
						According to <a href="http://www.istas.net/risctox/en/iframe/abreenlace.asp?idenlace=2226" target="_blank">Ministry of Environment of Germany</a>
					</td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;</td>
...
%>
			<blockquote>
				...
				<tr>
                	<td class="subtitulo3">
                    	Source: <a href="https://echa.europa.eu/addressing-chemicals-of-concern/authorisation/recommendation-for-inclusion-in-the-authorisation-list/authorisation-list" target="_blank">European Chemicals Agency (ECHA))</a>
                    </td>
				</tr>
			</table>
			</blockquote>
...
%>
	<table class="ficharisctox" width="90%" align="center" border="0" cellpadding="4" cellspacing="0">
   	<tr>
			<td class="celdaabajo" colspan="2" align="center">
				<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo2" align="left"><a href="index.asp?idpagina=617"><img src="imagenes/ayuda.gif" align="absmiddle" border="0" /></a> <%=objRstEnf("listado_ing")%>  <% plegador "secc-enf"&objRstEnf("listado_ing"), "img-enf"&objRstEnf("listado_ing") %></td></tr></table>
			</td>
		</tr>
...
' se eliminan vertidos y residuos de la versi�n inglesa
...
%>
		...
		<table width="100%" cellpadding=5>
			<tr>
				<td class="subtitulo3">
					<img src="imagenes/ico_normativa.gif" alt="Enviromental regulations" style="margin-right: 3px"/>Enviromental regulations
				</td>
				<td align="right">
					<a href="#"><img src="imagenes/subir.gif" border=0 alt=subir></a>
				</td>
...
'if esta_en_lista_vertidos then total = total +1 end if 'Se elimina en la versi�n inglesa
...
'if esta_en_lista_residuos then total = total +1 end if 'Se elimina en la versi�n inglesa
...
<%
		...
		if esta_en_lista_vertidos and false then ' Se elimina en la versi�n inglesa
		...
		if esta_en_lista_lpcic_agua and false then ' Se elimina en la versi�n inglesa
		...
		if esta_en_lista_lpcic_aire and false then ' Se elimina en la versi�n inglesa
		...
		if esta_en_lista_lpcic_suelo and false then ' Se elimina en la versi�n inglesa
		...
		if esta_en_lista_residuos and false then ' Se elimina en la versi�n inglesa
		...
		if esta_en_lista_accidentes and false then ' Se elimina en la versi�n inglesa
		...
		if esta_en_lista_emisiones and false then ' Se elimina en la versi�n inglesa
...
%>
		...
		<table width="100%" cellpadding=5>
			<tr>
				<td class="subtitulo3">
					<img src="imagenes/ico_normativa.gif" alt="Regulations on restriction / prohibition of substances" style="margin-right: 3px"/>Regulations on restriction
				</td>
				<td align="right">
					<a href="#"><img src="imagenes/subir.gif" border=0 alt=subir></a>
				</td>
...
%>
	...
	<table width="100%" cellpadding=5>
		<tr>
			<td class="subtitulo3">
				<img src="imagenes/ico_alternativas.gif" alt="Alternatives" height="32" style="margin-right: 6px;" />alternatives
			</td>
			<td align="right">
				<a href="#"><img src="imagenes/subir.gif" border=0 alt=subir></a>
			</td>
	...
	<table class="ficharisctox" width="90%" align="center" border="0" cellpadding="4" cellspacing="0">
   	<tr>
			<td class="celdaabajo" colspan="2" align="center">
				<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo2" align="left">Alternatives <% plegador "secc-alternativas", "img-alternativas" %></td></tr></table>
			</td>
		</tr>
...
%>
	...
	<table width="100%" cellpadding=5>
		<tr>
			<td class="subtitulo3">
				<img src="imagenes/ico_sectores.gif" alt="sectors" height="32" style="margin-right: 6px;" />sectors
			</td>
			<td align="right">
				<a href="#"><img src="imagenes/subir.gif" border=0 alt=subir></a>
			</td>
	...
	<table class="ficharisctox" width="90%" align="center" border="0" cellpadding="4" cellspacing="0">
   	<tr>
			<td class="celdaabajo" colspan="2" align="center">
				<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo2" align="left">Sectors where this substance is <% plegador "secc-sectores", "img-sectores" %></td></tr></table>
			</td>
		</tr>
...
%>
	...
	<table class="ficharisctox" width="90%" align="center" border="0" cellpadding="4" cellspacing="0">
   	<tr>
			<td class="celdaabajo" colspan="2" align="center">
				<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo2" align="left">Other health adverse effects and affected organs <% plegador "secc-salud", "img-salud" %></td></tr></table>
			</td>
		</tr>
...
<%
	...
	comentarios_sl = objrst("comentarios_ing")
...
' #############################################################################################
' Obtiene el nivel Cancerígeno de los campos de clasificaci�n
...
sub evaluaCamposListaAsociada(lista,camposArray())
	...
	if objRst("asoc_"&lista) then
		...
		for i = 0 to UBound(camposArray)
			c = camposArray(i)
			execute("q = " & c)
			execute("x = " & objRst("asoc_"&lista&"_"&c) )
