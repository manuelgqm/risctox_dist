...
<%
	...
	if errmes<>"" then
      ...
      enlace="http://www.istas.net/risctox/en/iframe/dn_risctox_ficha_sustancia.asp?id_sustancia="&id
        ...
        enlace=replace(enlace, "/web/", "/web/pruebas/web/")
			...
			If Err <> 0 Then
				...
				Response.Write Err.Description
					...
					response.write "The mail has been sent correctly. <br /><br /><input type='button' onclick='window.close()' value='Close window'  class='boton2' />"
			End If
	end if
