...
function arregla(texto)
	...
	if listado = "corap" then comentarios = generaComentarios_sin_grupo("ist_risc_sustancias_" & listado, "Year, Member State, Inital grounds for concern", "año,member_state,initial_grounds_for_concern")
