...
<% if 1=0 then %>
<table cellspacing=0 border=0 cellpadding=5 class=tabla width="95%" align="center">
<tr><td colspan="10"><table width="90%" align="center"><tr><td class="texto" align="left" width="75%">Si quieres solicitar la participación en uno de los siguientes cursos, márcalo:</td></tr> </table></td></tr>
<tr><td>&nbsp;</td><td><strong>Código</strong></td><td><strong>Curso on-line</strong></td><td><strong>Fecha</strong></td><td><strong>Inscripciones</strong></td></tr>
...
<tr><td class="celda" align="right"><input type="checkbox" name="FDT03" value="1" class="campo">&nbsp;</td><td class="celda">FDT03</td><td class="celda">Medio ambiente y actividades productivas: Prácticas sostenibles en agua, energía, residuos y emisiones</td><td class="celda">18/09/2006</td><td class="celda">hasta 14 de septiembre</td></tr>
<tr><td class="celda" align="right"><input type="checkbox" name="FDT04" value="1" class="campo">&nbsp;</td><td class="celda">FDT04</td><td class="celda">Medio ambiente y actividades productivas: Prácticas sostenibles en agua, energía, residuos y emisiones</td><td class="celda">25/09/2006</td><td class="celda">hasta 21 de septiembre</td></tr>
<tr><td class="celda" align="right"><input type="checkbox" name="FDT05" value="1" class="campo">&nbsp;</td><td class="celda">FDT05</td><td class="celda">Prevención del riesgo químico</td><td class="celda">10/05/2006</td><td class="celda">hasta 9 de mayo</td></tr>
<tr><td class="celda" align="right"><input type="checkbox" name="FDT06" value="1" class="campo">&nbsp;</td><td class="celda">FDT06</td><td class="celda">Prevención del riesgo químico</td><td class="celda">11/09/2006</td><td class="celda">hasta 9 de mayo</td></tr>
</table>
<% end if %>
<br>&nbsp;
