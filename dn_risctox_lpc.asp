...
filtro=request("filtro")  'ep1(agua), ep2(aire), ep3(suelo)
select case filtro
	case "ep1"
		coletilla="(PRTR Agua)"
	case "ep2"
		coletilla="(PRTR Aire)"
	case "ep3"
		coletilla="(PRTR Suelo)"
end select
if filtro="" then filtro="lpc"
...
<p class=titulo3>RISCTOX: Sustancias IPPC <%=coletilla%></p>


<form action="dn_risctox_lpc.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
...
<tr>
  <td colspan="3" class="subtitulo3">Buscador</td></td></tr>
	...
	<tr>
		<td colspan="2" align="center"><input type="submit" value="Buscar" class="boton" /> <input type="reset" class="boton" value="Borrar" /></td>
	</tr>
</table>
