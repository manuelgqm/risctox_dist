...
<p class=titulo3>RISCTOX: 	Sustancias cancer&iacute;genas o mut&aacute;genas (seg&uacute;n RD 363/1995)</p>


<form action="dn_risctox_cym.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
...
<tr>
  <td colspan="3" class="subtitulo3">Buscador</td></td></tr>
	...
	<tr>
		...
		<td><input type="text" name="numero" value="<%=numero%>" class="boton2"/></td>
	</tr>	
	<tr>
		<td colspan="2" align="center"><input type="submit" value="Buscar" class="boton" /> <input class="boton" type="reset" value="Borrar" /></td>
	</tr>
</table>
