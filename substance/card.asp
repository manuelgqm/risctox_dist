<!--#include file="../config/checkAccess.asp"-->
<!--#include file="../config/dbConnection.asp"-->
<!--#include file="../lib/helper.asp"-->
<!--#include file="../lib/stringHelper.asp"-->
<!--#include file="../lib/requestHelper.asp"-->
...
'----- Registrar la visita
	...
	'navegador = Cstr(MiBrowser.Browser)
...
id_sustancia = requestClean("id_sustancia")
if id_sustancia = "" then id_sustancia = 957597 '## Debug override formol
' id_sustancia = 1024417 '## Debug override bisfenol
...
sql = sql & " FULL OUTER JOIN spl_risc_sustancias_prohibidas_embarazadas ON dn_risc_sustancias.id = spl_risc_sustancias_prohibidas_embarazadas.id_sustancia " &_
" full outer join ist_risc_sustancias_epa as epa on dn_risc_sustancias.id = epa.id_sustancia "
...
if(objRst.eof) then
	...
	frases_r_epa = trim( objRst( "frases_r_danesa" ) )
	frases_h_epa = trim( objRst( "frases_h" ) )
	...
	if objRst("notas_rd1272") <> null then
	...
	if nivel_disruptor <> null then vector_disruptores = split(nivel_disruptor,",")
...
set substance = getSubstanceAttributes( id_sustancia )
esta_en_lista_cancer_rd = esta_en_lista("cancer_rd", id_sustancia)
esta_en_lista_cancer_rd_h = esta_en_lista_cancer_rd_h or esta_en_lista ("cancer_rd_h", id_sustancia)
esta_en_lista_cancer_epa = esta_en_lista_cancer_epa or esta_en_lista ("cancer_epa", id_sustancia)
esta_en_lista_cancer_epa_h = esta_en_lista_cancer_epa_h or esta_en_lista( "cancer_epa_h", id_sustancia )
esta_en_lista_mutageno_rd = esta_en_lista_mutageno_rd or esta_en_lista ("mutageno_rd", id_sustancia)
esta_en_lista_mutageno_epa = esta_en_lista_mutageno_epa or esta_en_lista ("mutageno_epa", id_sustancia)
esta_en_lista_mutageno_epa_h = esta_en_lista_mutageno_epa_h or esta_en_lista ("mutageno_epa_h", id_sustancia)
...
esta_en_lista_tpr_epa = esta_en_lista_tpr_epa or esta_en_lista ("tpr_epa", id_sustancia)
esta_en_lista_tpr_epa_h = esta_en_lista_tpr_epa_h or esta_en_lista ("tpr_epa_h", id_sustancia)
...
esta_en_lista_neurotoxico_epa = esta_en_lista_neurotoxico_epa or  esta_en_lista ("neurotoxico_epa", id_sustancia)
esta_en_lista_neurotoxico_epa_h = esta_en_lista_neurotoxico_epa_h or  esta_en_lista ("neurotoxico_epa_h", id_sustancia)
esta_en_lista_neurotoxico_nivel = esta_en_lista_neurotoxico_nivel or esta_en_lista ("neurotoxico_nivel", id_sustancia)
esta_en_lista_neurotoxico = esta_en_lista_neurotoxico or esta_en_lista_neurotoxico_rd OR esta_en_lista_neurotoxico_epa or esta_en_lista_neurotoxico_epa_h OR esta_en_lista_neurotoxico_nivel OR esta_en_lista ("neurotoxico", id_sustancia)

esta_en_lista_sensibilizante = esta_en_lista_sensibilizante or esta_en_lista ("sensibilizante", id_sustancia)
esta_en_lista_sensibilizante_epa = esta_en_lista_sensibilizante_epa or esta_en_lista ("sensibilizante_epa", id_sustancia)
esta_en_lista_sensibilizante_epa_h = esta_en_lista_sensibilizante_epa_h or esta_en_lista ("sensibilizante_epa_h", id_sustancia)
...
' Condiciones para mostrar las frases R epas en Clasificacion
' Se mostrarán si existen las frases R epas y NO existen las de RD
...
if (frases_r = "") and (frases_r_epa <> "") then
  frases_r_epa_mostradas=true
else
  frases_r_epa_mostradas=false
end if

if (frases_h = "") and (frases_h_epa <> "") then
  frases_h_epa_mostradas = true
else
  frases_h_epa_mostradas = false
end if
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../ist_estilos.css">
	...
	<script src="textHelper.js" type="text/javascript"></script>
</head>
				...
				<div id="texto">
					...
					<div class="texto">
						<table width="100%" border="0">
							<tr>
								<td>
									<p class=campo>Est&aacute;s en: <a href="dn_risctox_buscador.asp">bbdd risctox</a> &gt; ficha de sustancia</p>
								</td>
								<td align="right">
...
%>
	<tr>
		<td class="subtitulo3" align="right" valign="top">
			<a onclick=window.open('showDefinition.asp?id=82','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' /></a> Nombre:
		</td>
	...
	%>
		<tr>
			<td class="subtitulo3" align="right" valign="top">
				<a onclick=window.open('showDefinition.asp?id=83','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' /></a> Sinónimos:
			</td>
			<td class="texto" valign="middle">
				<%=sinonimos%>
			</td>
	...
	<% if (num_cas <> "") or (num_ce_einecs <> "") or (num_ce_elincs <> "") then %>
		<tr>
			...
			<td class="texto" valign="middle">
				<% if (num_cas <> "") then response.write "<a onclick=window.open('showDefinition.asp?id=84','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' /></a> <b>CAS</b>: "&num_cas&"<br/>" %>
				<% if (cas_alternativos <> "") then response.write "<a onclick=window.open('showDefinition.asp?id=84','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' /></a> <b>CAS alternativos</b>: "&cas_alternativos &"<br/>" %>
				<%
					if (num_ce_einecs <> "") then
						if (mid(num_ce_einecs,1,1)="4" and num_ce_elincs <> "") then
							response.write "<a onclick=window.open('showDefinition.asp?id=85','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' /></a> <b>CE ELINCS</b>: "&num_ce_elincs&"<br/>"
						else
						response.write "<a onclick=window.open('showDefinition.asp?id=85','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' /></a> <b>CE EINECS</b>: "&num_ce_einecs&"<br/>"
						end if
	...
	%>
		<tr>
			<td class="subtitulo3" align="right" valign="top">
				 Ficha Internacional de Seguridad Química (<a onClick="window.open('showDefinition.asp?id=<%=dame_id_definicion("INSHT")%>', 'def', 'width=300,height=200,scrollbars=yes,resizable=yes')" class="subtitulo3">INSHT</a>)
			</td>
			<td class="texto" valign="middle">
          <%
	...
	<% if (nombre_ing <> "") or (num_rd <> "") or (formula_molecular <> "") or (estructura_molecular <> "") or (notas_xml <> "") or (companias <> "") then %>
        ...
        <%
				...
				<% if (num_rd <> "") then response.write "<a onclick=window.open('showDefinition.asp?id=86','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' /></a> <b>Nº &iacute;ndice</b>: "&num_rd&"<br/>" %>
				...
				<% if (notas_xml <> "") then %>
          <a onClick="window.open('showDefinition.asp?id=<%=dame_id_definicion("ECB")%>', 'def', 'width=300,height=200,scrollbars=yes,resizable=yes')" style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
...
%>
  ...
  <tr>
		<td class="celdaabajo" colspan="2" align="center">
			<table cellpadding=0 cellspacing=0 width="100%" border="0"><tr><td width="100%" class="titulo3" align="left"><a onclick=window.open('showDefinition.asp?id=87','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> CLASIFICACIÓN (RD 363/1995)
	...
	<tr><td>
		<table id="secc-clasificacion-363" style="display:none">
			<tr>
		        ...
		        if frases_h_epa_mostradas then
		          ap2_clasificacion_frases_h_epa()
		        elseif frases_r_epa_mostradas then
		          ap2_clasificacion_frases_r_epa()
		        end if
		      %>
...
function buscaDefinicionAsteriscos(cadena)
	if (InStr(cadena,"****")>0) then
		cadena = replace(cadena, "****", "<a onclick=window.open('showDefinition.asp?id=" + CStr(dame_id_definicion("****")) + "','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'>****</a>")
	else
		if (InStr(cadena,"***")>0) then
			cadena = replace(cadena, "***", "<a onclick=window.open('showDefinition.asp?id=" + CStr(dame_id_definicion("***")) + "','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'>***</a>")
		else
...
sub ap2_clasificacion_frases_r_epa()
	aux = monta_frases_rh_epa(frases_r_epa, "R")

	if (aux <> "") then
%>
	<p id="ap2_clasificacion_frases_r_epa_titulo" class="ficha_titulo_2"><a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("Frases R según la lista epa de la EPA")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> Frases R según clasificación de la EPA epa</p>
<%
		bucle_frases "r", aux
	end if
end sub

sub ap2_clasificacion_frases_h_epa()

	aux = monta_frases_rh_epa(frases_h_epa, "H")

	if (aux <> "") then
%>
	<p id="ap2_clasificacion_frases_h_epa_titulo" class="ficha_titulo_2"><a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("Frases H según la lista epa de la EPA")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> Frases H según clasificación de la EPA epa</p>
<%
		bucle_frases "h", aux
	end if
end sub
...
%>
			...
			<b><%=nota%></b> <a onclick=window.open('showDefinition.asp?id=<%=id_nota%>','def','width=600,height=400,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a><br />
<%
			end if
		next
%>
...
%>
	<span id="ap2_clasificacion_etiquetado_titulo" class="ficha_titulo_2"><a onclick=window.open('showDefinition.asp?id=88','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> Etiquetado <% plegador "secc-etiquetado", "img-etiquetado" %></span>
...
%>
			<tr>
				<td class="celdaabajo"><%= h(c) %></td><td class="celdaabajo"><%= h(e) %> <a onClick="window.open('<%=tipo_frase%>Word.asp?id=<%=e%>','fr','width=300,height=200,scrollbars=yes,resizable=yes')" style="text-decoration:none;cursor:pointer"><img src="../imagenes/ayuda.gif" border="0" align="absmiddle" alt="busca Frases R"></a></td>
			</tr>
<%
	  end if
  else
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="3">
		<tr>
			...
			<% if (ap2_clasificacion_vl_a_hay_columna_vla_ed_ppm or  ap2_clasificacion_vl_a_hay_columna_vla_ed_mg_m3) then %>
				<td class="subtitulo3 celdaabajo"><a onclick=window.open('showDefinition.asp?id=230','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> VLA-ED</td>
			<% end if %>

			<% if (ap2_clasificacion_vl_a_hay_columna_vla_ec_ppm or  ap2_clasificacion_vl_a_hay_columna_vla_ec_mg_m3) then %>
				<td class="subtitulo3 celdaabajo"><a onclick=window.open('showDefinition.asp?id=229','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> VLA-EC</td>
			<% end if %>
...
%>
			...
			<% if ap2_clasificacion_vl_b_hay_columna_momento then %>
				<td style="	border-bottom-color: #DDDDDD;	border-bottom-style: solid;	border-bottom-width: 1px;" valign="middle"><%=parche_definicion(momento, "MomentoVLBInicio")%><a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion(parche_definicion(momento, "MomentoVLB"))%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><%= parche_definicion(momento, "MomentoVLB") %></a>
				</td>
			<% end if %>
...
sub notas_con_ayuda(byval notas, byval tipo)
	...
	for i=0 to ubound(array_notas)
		...
		if (nota <> "") then
			if (cadena_notas = "") then '#Exception
				cadena_notas = "<a onclick=window.open('showDefinition.asp?id="&id_nota&"','def','width=600,height=400,scrollbars=yes,resizable=yes') style='cursor:pointer'>"&nota&"</a>"
			else
				cadena_notas = cadena_notas & ", <a onclick=window.open('showDefinition.asp?id="&id_nota&"','def','width=600,height=400,scrollbars=yes,resizable=yes') style='cursor:pointer'>"&nota&"</a>"
			end if
		end if
	next
...
sub ap2_clasificacion_lista_negra() ' Muestra el etiquetado

	if (esta_en_lista_cancer_rd or esta_en_lista_cancer_rd_h or esta_en_lista_cancer_epa or esta_en_lista_cancer_epa_h or esta_en_lista_cancer_iarc_excepto_grupo_3 or esta_en_lista_cancer_otras_excepto_grupo_4 or esta_en_lista_de or (esta_en_lista_neurotoxico and (instr(frases_r,"R67")=0)) or  esta_en_lista_tpb or esta_en_lista_sensibilizante or esta_en_lista_sensibilizante_epa or esta_en_lista_sensibilizante_epa_h or esta_en_lista_sensibilizante_reach or esta_en_lista_tpr or esta_en_lista_tpr_epa or esta_en_lista_tpr_epa_h or esta_en_lista_mutageno_rd or esta_en_lista_mutageno_epa or esta_en_lista_mutageno_epa_h or esta_en_lista_cancer_mama or esta_en_lista_cop) or (instr(frases_r,"R33")<>0) or (instr(frases_r,"R53")<>0) or (instr(frases_r,"R50-53")<>0) or (instr(frases_r,"R51-53")<>0) or (instr(frases_r,"R52-53")<>0) or (instr(frases_r,"R58")<>0) then
    ...
    objConnection2.execute(sqlListaNegra),,adexecutenorecords
		...
		if (esta_en_lista_cancer_rd or esta_en_lista_cancer_rd_h or esta_en_lista_cancer_epa or esta_en_lista_cancer_epa_h or esta_en_lista_cancer_iarc_excepto_grupo_3 or esta_en_lista_cancer_otras_excepto_grupo_4 or esta_en_lista_cancer_mama) then
			if (razones = "") then
				razones = "cancerígena"
			else
		...
		if (esta_en_lista_mutageno_rd or esta_en_lista_mutageno_epa or esta_en_lista_mutageno_epa_h) then
			if (razones = "") then
				razones = "mutágena"
			else
		...
		if (esta_en_lista_sensibilizante or esta_en_lista_sensibilizante_epa or esta_en_lista_sensibilizante_epa_h or esta_en_lista_sensibilizante_reach) then
			if (razones = "") then
		...
		if (esta_en_lista_tpr or esta_en_lista_tpr_epa or esta_en_lista_tpr_epa_h) then
			if (razones = "") then
...
%>
		<p id="ap2_clasificacion_lista_negra_titulo" class="subtitulo3">&nbsp;<img src="../imagenes/icono_atencion_20.png" align="absmiddle" /> <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("Lista negra")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a> Sustancia incluida en la Lista negra de ISTAS <% plegador "secc-listanegra", "img-listanegra" %></p>
...
sub ap3_riesgos()
	...
	if inStr( substance.item( "categorias" ), "riesgos_salud" ) then
%>
...
<%
		if (esta_en_lista_cancer_rd or esta_en_lista_cancer_rd_h or esta_en_lista_cancer_epa_h or esta_en_lista_cancer_iarc or esta_en_lista_cancer_otras or esta_en_lista_cancer_mama) then ap3_riesgos_tabla("Cancerígeno") end if
		if (esta_en_lista_mutageno_rd or esta_en_lista_mutageno_epa or esta_en_lista_mutageno_epa_h ) then ap3_riesgos_tabla("Mutágeno") end if
		...
		if esta_en_lista_sensibilizante or esta_en_lista_sensibilizante_epa or esta_en_lista_sensibilizante_epa_h or esta_en_lista_sensibilizante_reach then ap3_riesgos_tabla("Sensibilizante") end if
		if esta_en_lista_tpr or esta_en_lista_tpr_epa or esta_en_lista_tpr_epa_h then ap3_riesgos_tabla("Tóxico para la reproducción") end if
...
<% ' MEDIO AMBIENTE %>
<%
if inStr( substance.item( "categorias" ), "riesgos_medio_ambiente" ) then
...
%>
					 		<a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("C"&nivel_cancerigeno_rd_txt)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
<%
				end if
%>
...
<%
				...
				' Lista epa ---------------------------------------------------------------
					if (esta_en_lista_cancer_epa_h) then	%>
					<fieldset>
						<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_h_epa_cancer", "frases H", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>.</strong></legend>
						<blockquote>
						<%
						nivel_cancerigeno_epa = dame_nivel_cancerigeno_epa( frases_h_epa )
						if (nivel_cancerigeno_epa <> "") then
							response.write "<strong>Nivel cancerígeno:</strong> "&nivel_cancerigeno_epa
						%>

						<a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("RDC"&nivel_cancerigeno_epa)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
						
					<% elseif (esta_en_lista_cancer_epa) then	%>
					<fieldset>
						<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_r_epa_cancer", "frases R", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>.</strong></legend>
						<blockquote>
						<%
						nivel_cancerigeno_epa = dame_nivel_cancerigeno_epa( frases_r_epa )
						if (nivel_cancerigeno_epa <> "") then
							response.write "<strong>Nivel cancerígeno:</strong> "&nivel_cancerigeno_epa
						%>
		...
		%>
		        <div id="frases_r_epa_cancer" style="display:none"><br />
		        <% ap2_clasificacion_frases_r_epa() %>
		        </div>
						
						<div id="frases_h_epa_cancer" style="display:none"><br />
		        <% ap2_clasificacion_frases_h_epa() %>
		        </div>
		...
		%>
					<fieldset>
						<legend class="subtitulo3"><strong>Según IARC <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("IARC")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></strong></legend>
		<%
		...
		%>
								<tr><td class="subtitulo3">Grupo:</td><td><%=trim(replace(ucase(grupo_iarc), "GRUPO", ""))%> <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion(trim(grupo_iarc))%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></td></tr>
		<%
							end if
		...
		%>
					...
					<fieldset>
						<legend class="subtitulo3"><strong>Según SSI (cáncer de mama) <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("SSI")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></strong></legend>
						<blockquote>
						<table>
...
%>
			<fieldset>
				...
				%>
					 <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("M"&nivel_mutageno_rd_txt)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
				<%
					end if
				%>
				</blockquote>
...
<%
      ...
      ' MUTAGENO epa -------------------------------------------------------------
			if esta_en_lista_mutageno_epa_h then %>
				<fieldset>
					<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_h_epa_mutageno", "frases H", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>.</strong></legend>
					<blockquote>
					<%
						nivel_mutageno_epa_h = dame_nivel_mutageno_epa_h()
						if (nivel_mutageno_epa_h <> "") then
						response.write "<br /><strong>Nivel mutágeno:</strong> " & nivel_mutageno_epa_h
					%>
						 <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("RDM"&nivel_mutageno_epa_h)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
					<%
						end if
					%>

					<div id="frases_h_epa_mutageno" style="display:none"><br />
					<% ap2_clasificacion_frases_h_epa() %>
					</div>
			...
			<% elseif (esta_en_lista_mutageno_epa) then %>
				<fieldset>
					<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_r_epa_mutageno", "frases R", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>.</strong></legend>
					<blockquote>
					<%
						nivel_mutageno_epa = dame_nivel_mutageno_epa()
						if (nivel_mutageno_epa <> "") then
						response.write "<br /><strong>Nivel mutágeno:</strong> "&nivel_mutageno_epa
					%>
						 <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("RDM"&nivel_mutageno_epa)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
					<%
						end if
					%>

					<div id="frases_r_epa_mutageno" style="display:none"><br />
					<% ap2_clasificacion_frases_r_epa() %>
					</div>
...
<%
        ...
        if esta_en_lista_neurotoxico_rd or esta_en_lista_neurotoxico_epa or esta_en_lista_neurotoxico_epa_h then
        ...
        if esta_en_lista_neurotoxico_epa then
          if (fuente_neurotoxico = "") or (IsNull(fuente_neurotoxico)) then
            ...
            fuente_neurotoxico = fuente_neurotoxico & ",EPA-R67"
				...
				if esta_en_lista_neurotoxico_epa_h then
          if (fuente_neurotoxico = "") or (IsNull(fuente_neurotoxico)) then
            fuente_neurotoxico = "EPA-NEURO"
          else
            fuente_neurotoxico = fuente_neurotoxico & ",EPA-NEURO"
          end if
				end if
      %>
      ...
      <% if ((efecto_neurotoxico <> "") or (nivel_neurotoxico <> "") or (fuente_neurotoxico <> "")) then %>
			...
			<%	if (efecto_neurotoxico <> "") then %>
                ...
                'efecto = montartildes(efecto)
						...
						<%= efecto %> <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion(efecto)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
			...
			<% if (nivel_neurotoxico <> "") then %>
				<tr>
					<td class="subtitulo3" valign="top">Nivel:</td><td><%=nivel_neurotoxico%>
					 ...
					 <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("Nivel "&nivel_neurotoxico)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
			...
			%>
            <!--
			 <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion(trim(array_fuentes(i)))%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
			 -->
          <%
...
<%
		...
		case "Sensibilizante":
		      response.write "<ul>"
					' Indicamos si es por lista RD o por lista epa
			  ...
			  if esta_en_lista_sensibilizante_reach then
				...
				if esta_en_lista_sensibilizante_epa_h then %>
					<li class='subtitulo3'>Sensibilizante según <% plegador_texto "frases_h_epa_sensibilizante", "frases H", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></li>
		      <%


		      %>
		        <div id="frases_h_epa_sensibilizante" style="display:none"><br />
		        <blockquote>
		        <% ap2_clasificacion_frases_h_epa() %>
		        </blockquote>
		        </div>
		      <%
		    elseif esta_en_lista_sensibilizante_epa then
		      %>
		        <li class='subtitulo3'>Sensibilizante según <% plegador_texto "frases_r_epa_sensibilizante", "frases R", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></li>
		      <%


		      %>
		        <div id="frases_r_epa_sensibilizante" style="display:none"><br />
		        <blockquote>
		        <% ap2_clasificacion_frases_h_epa() %>
		        </blockquote>
		        </div>
				...
				nivel_reproduccion_rd_txt = replace(nivel_reproduccion_rd_txt, "3", "2")
				  ...
				  %>
	  				<blockquote>
	  				  ...
	  				  <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("TR"&nivel_reproduccion_rd_txt)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
	  					</blockquote>
	  			<%
	  			end if
	%>
	...
	<%
	      ...
	      ' TPR SEGUN LISTA epa ---------------------------------------------------
				if esta_en_lista_tpr_epa_h then %>
					<fieldset>
	  				<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_h_epa_tpr", "frases H", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></strong></legend>
	<%
	  			nivel_reproduccion_epa_h = dame_nivel_reproduccion_epa_h()
	  			if (nivel_reproduccion_epa_h <> "") then
				  %>
	  				<blockquote>
	  					<strong>Categoría:</strong> <%=nivel_reproduccion_epa_h%>
	  				  <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("RDR"&nivel_reproduccion_epa_h)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
	  					</blockquote>
	  			<%
	  			end if
	%>
	        <div id="frases_h_epa_tpr" style="display:none"><br />
	        <blockquote>
	        <% ap2_clasificacion_frases_h_epa() %>
	        </blockquote>
	        </div>
	      ...
	      <% elseif (esta_en_lista_tpr_epa) then %>
	    			<fieldset>
	  				<legend class="subtitulo3"><strong>Según <% plegador_texto "frases_r_epa_tpr", "frases R", "subtitulo3" %> en la clasificación de la EPA epa <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("EPA epa")%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a></strong></legend>
	<%
	  			nivel_reproduccion_epa = dame_nivel_reproduccion_epa()
	  			if (nivel_reproduccion_epa <> "") then
				  %>
	  				<blockquote>
	  					<strong>Categoría:</strong> <%=nivel_reproduccion_epa%>
	  				  <a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion("RDR"&nivel_reproduccion_epa)%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
	  					</blockquote>
	  			<%
	  			end if
	%>
	        <div id="frases_r_epa_tpr" style="display:none"><br />
	        <blockquote>
	        <% ap2_clasificacion_frases_r_epa() %>
	        </blockquote>
	        </div>
...
%>
			...
			<table>
				<tr>
					<td class="subtitulo3">
	                    <a href="#" onClick="window.open('showComments.asp?listado=restringidas&id=<%=id_sustancia%>','Informacion','width=500,height=230,scrollbars=yes,resizable=yes')">Más información</a>
                    </td>
...
%>
			<blockquote>
				...
				<tr>
                	<td class="subtitulo3">
                    	<a href="#" onClick="window.open('showComments.asp?listado=prohibidas&id=<%=id_sustancia%>','Informacion','width=500,height=230,scrollbars=yes,resizable=yes')">Más información</a>
                    </td>
				</tr>
			</table>
			</blockquote>
...
%>
				...
				<tr>
					...
					<td><strong>Clasificación</strong>: <%=clasif_mma%>
					 	<a onclick=window.open('showDefinition.asp?id=<%=dame_id_definicion(parche_definicion(clasif_mma, "MMA"))%>','def','width=300,height=200,scrollbars=yes,resizable=yes') style='cursor:pointer'><img src='../imagenes/ayuda.gif' width=14 height=14 align='absmiddle' border='0' /></a>
					</td>
				</tr>
<%
			end if
...
%>
			<blockquote>
				...
				<tr>
                	<td class="subtitulo3">
                    	<a href="#" onClick="window.open('showComments.asp?listado=biocidas_prohibidas&id=<%=id_sustancia%>','Informacion','width=500,height=230,scrollbars=yes,resizable=yes')">Más información</a>
                    </td>
				</tr>
			</table>
			</blockquote>
...
%>
			<blockquote>
				...
				<tr>
                	<td class="subtitulo3">
                    	<a href="#" onClick="window.open('showComments.asp?listado=biocidas_autorizadas&id=<%=id_sustancia%>','Informacion','width=500,height=230,scrollbars=yes,resizable=yes')">Más información</a>
                    </td>
				</tr>
			</table>
			</blockquote>
...
%>
			<blockquote>
				...
				<tr>
                	<td class="subtitulo3">
                    	<a href="#" onClick="window.open('showComments.asp?listado=pesticidas_prohibidas&id=<%=id_sustancia%>','Informacion','width=500,height=230,scrollbars=yes,resizable=yes')">Más información</a>
                    </td>
				</tr>
			</table>
			</blockquote>
...
%>
			<blockquote>
				...
				<tr>
                	<td class="subtitulo3">
                    	<a href="#" onClick="window.open('showComments.asp?listado=pesticidas_autorizadas&id=<%=id_sustancia%>','Informacion','width=500,height=230,scrollbars=yes,resizable=yes')">Más información</a>
                    </td>
				</tr>
			</table>
			</blockquote>
...
%>
			<blockquote>
				...
				<tr>
					<td class="subtitulo3">
							<a href="#" onClick="window.open('showComments.asp?listado=corap&id=<%=id_sustancia%>','Informacion','width=500,height=230,scrollbars=yes,resizable=yes')">Mas información</a>
						</td>
				</tr>
				<tr>
					<td class="subtitulo3">
...
%>
					<li><a href="alternativasFileCard.asp?id_fichero=<%=id_fichero%>"><%=titulo%></a></li>
<%
...
sub ap6_sectores()
	...
	sql="SELECT DISTINCT s.numero_cnae AS codigo, s.nombre AS nombre, s.id AS id_sector FROM dn_alter_sectores AS s LEFT OUTER JOIN dn_risc_sustancias_por_sectores AS sps ON s.id = sps.id_sector WHERE sps.id_sustancia="&id_sustancia&" ORDER BY s.numero_cnae"
...
%>
					<li><a href="alternativasSectorCard.asp?id=<%=id_sector%>"><%=codigo%> - <%=nombre%></a></li>
<%
      else
%>
					<li><%=codigo%> - <%=nombre%></li>
...
function dame_nivel_cancerigeno_epa( frases )
	' Buscamos la primera aparicion de "Carc"
	posicion = instr(1,frases, "Carc")

	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_cancerigeno_epa = mid(frases, posicion+4, 1)
	else
		dame_nivel_cancerigeno_epa = ""
	end if
end function
...
function dame_nivel_mutageno_epa_h()
	' Buscamos la primera aparicion de "Muta"
	posicion = instr(1,frases_h_epa, "Muta")
	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_mutageno_epa_h = mid(frases_h_epa, posicion + 4, 1)
	else
		dame_nivel_mutageno_epa_h = ""
	end if
end function
...
function dame_nivel_reproduccion_epa()
	' Buscamos la primera aparicion de "Repr.Cat."
	posicion = instr(1,frases_r_epa, "Repr.Cat.")

	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_reproduccion_epa = mid(frases_r_epa, posicion+9, 1)
	else
		dame_nivel_reproduccion_epa = ""
	end if
end function

function dame_nivel_reproduccion_epa_h()
	' Buscamos la primera aparicion de "Repr.Cat."
	posicion = instr(1, frases_h_epa, "Repr")
	' Sacamos el nivel como el caracter que hay justo detrás de la primera aparición de la subcadena
	if (posicion > 0) then
		dame_nivel_reproduccion_epa_h = mid(frases_h_epa, posicion + 4, 1)
	else
		dame_nivel_reproduccion_epa_h = ""
	end if
end function
...
sub plegador_texto(byval id_bloque, byval texto, byval clase)
  ...
  ' Solo se emplea para el plegador de frases R epas, en caso de que no se hayan mostrado ya.
  id_bloque=aplana(id_bloque)
