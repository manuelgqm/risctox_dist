...
<fieldset>
	<legend><strong>RIESGOS ESPECÍFICOS SOBRE LA SALUD</strong></legend>
	<fieldset>
...
<fieldset>
  <legend><strong>RIESGOS ESPECÍFICOS PARA EL MEDIO AMBIENTE</strong></legend>
 ...
 <fieldset>
  ...
  <input type="hidden" name="hayt1" value="<%=hayt1%>" />
       <fieldset>
			  <legend><strong>Valors límites de exposición Ambiental</strong></legend>
				<table >
			  <tr>
			  <th> </th>
			  <th>ESTADO</th>
