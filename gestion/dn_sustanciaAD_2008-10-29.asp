...
<form name="myform" action="dn_sustanciaAD2.asp?id=<%=id%>" method="post" >
 ...
 <fieldset>
  <legend><strong>Valores l&iacute;mite de exposici&oacute;n profesional </strong></legend>
  <input type="hidden" name="hayt1" value="<%=hayt1%>" />
  <fieldset>
  <legend><strong>Ambiental</strong></legend>
    <table >
  <tr>
  <th> </th>
  <th>ESTADO</th>
  ...
  <fieldset>
  <legend><strong>Biol&oacute;gico</strong></legend>
  <table >
  <tr>
  <th> </th>
 ...
 <!- ########################################### -->
  ...
  <table >
    ...
    <tr>
      ...
      <!-- 
		  <td>
		  <input name="t4_fuente_neurotoxico" type="text" id="t4_fuente_neurotoxico" value="<%=fuente_neurotoxico%>" size="100" maxlength="40" /> 
		  </td>
	   -->
...
<!--
 <table >
 <tr>
   <td>Nivel de disrupci&oacute;n endocrina </td>
   <td><input name="t4_nivel_disruptor" type="text" id="t4_nivel_disruptor" value="<%=nivel_disruptor%>" size="5" maxlength="5" /></td></tr>
 ...
 -->
  ...
  <fieldset>
  <legend><strong>Medio ambiente</strong></legend>
 ...
 %>
  <tr>
    ...
    <fieldset>
  <legend><strong>Riesgos para el medio ambiente</strong></legend>
  <table >
  <tr><td valign="top">
  ...
  <fieldset style="margin-left:10px; "><legend><strong>Normativa ambiental</strong></strong></legend>
  <input type="checkbox" value="1"  name="t5_emisiones_atmosfera" <%=dimechecked(emisiones_atmosfera)%> /> 
  Emisiones atmosf&eacute;ricas <br />
  <input type="checkbox" value="1"  name="t5_cov" <%=dimechecked(cov)%> />
   Compuestos org&aacute;nicos vol&aacute;tiles <br />
   <input type="checkbox" value="1"  name="t5_seveso" <%=dimechecked(seveso)%> /> 
   Seveso accidentes graves <br />
     <input type="checkbox" value="1"  name="t5_eper_agua" <%=dimechecked(eper_agua)%> /> 
  EPER (LPCC) agua <br />
  <input type="checkbox" value="1"  name="t5_eper_aire" <%=dimechecked(eper_aire)%> />
   EPER (LPIC) aire<br />
 ...
 <!- ########################################### -->
 <fieldset>
 <legend><strong>Más información</strong></legend>
 <table>
  <tr>
    <td align='center'>
