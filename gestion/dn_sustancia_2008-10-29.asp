...
<form name="myform" action="dn_sustancia2.asp?id=<%=id%>" method="post" enctype="multipart/form-data">
  ...
  <fieldset><legend><strong>Identificaci&oacute;n
de la sustancia</strong></legend>
Nombre <span class="exp">(obligatorio,
max 750 c.)</span><br>  <textarea cols="60" rows="3" name="nombre"><%=nombre%></textarea><br>  <br>Nombre en ingl&eacute;s <span class="exp">(max
750 c.)</span><br>  <textarea cols="60" rows="3" name="nombre_ing"><%=nombre_ing%></textarea><br>  <br>Sin&oacute;nimos <span class="exp">(separados por <strong>@</strong> Cada uno max 750 c.)</span><br>  <textarea cols="60" rows="3" name="sinonimos"><%=sinonimos%></textarea><br>  <br>
Nombres comerciales <span class="exp">(Separados por <strong>@</strong>; Cada uno max 100 c.)</span><br>  <textarea cols="60" rows="3" name="nombres_comerciales"><%=nombres_comerciales%></textarea><br>  <br>
...
RD <span class="exp">(max 20 c.) </span><input maxlength="50" size="20" name="num_rd" value="<%=num_rd%>" /><br>  <br>N&uacute;mero CE/EINECS <span class="exp">(max
20 c.) </span><input maxlength="50" size="20" name="num_ce_einecs" value="<%=num_ce_einecs%>" /><br>  <br>N&uacute;mero CE/ELINCS <span class="exp">(max
20 c.) </span><input maxlength="50" size="20" name="num_ce_elincs" value="<%=num_ce_elincs%>" /><br>  <br>N&uacute;mero CAS <span class="exp">(max
20 c.) </span><input maxlength="50" size="20" name="num_cas" value="<%=num_cas%>" /><br>  <br>N&uacute;mero ONU <span class="exp">(max
20 c.) </span><input maxlength="50" size="20" name="num_onu" value="<%=num_onu%>" /><br>  <br>
  </fieldset>  <br>  
...
%>
  ...
  <fieldset><legend><strong>Clasificaci&oacute;n</strong></legend>S&iacute;mbolos:
...
Concentraci&oacute;n 01&nbsp;<input value="<%=conc_1%>" maxlength="25" size="25" name="conc_1"> &nbsp;Etiquetado
01&nbsp;<input value="<%=eti_conc_1%>" maxlength="50" size="35" name="eti_conc_1"><br>Concentraci&oacute;n 02&nbsp;<input value="<%=conc_2%>" maxlength="25" size="25" name="conc_2"> &nbsp;Etiquetado
02&nbsp;<input value="<%=eti_conc_2%>" maxlength="50" size="35" name="eti_conc_2"><br>Concentraci&oacute;n 03&nbsp;<input value="<%=conc_3%>" maxlength="25" size="25" name="conc_3"> &nbsp;Etiquetado
03&nbsp;<input value="<%=eti_conc_3%>" maxlength="50" size="35" name="eti_conc_3"><br>Concentraci&oacute;n 04&nbsp;<input value="<%=conc_4%>" maxlength="25" size="25" name="conc_4"> &nbsp;Etiquetado
04&nbsp;<input value="<%=eti_conc_4%>" maxlength="50" size="35" name="eti_conc_4"><br>Concentraci&oacute;n 05&nbsp;<input value="<%=conc_5%>" maxlength="25" size="25" name="conc_5"> &nbsp;Etiquetado
05&nbsp;<input value="<%=eti_conc_5%>" maxlength="50" size="35" name="eti_conc_5"><br>Concentraci&oacute;n 06&nbsp;<input value="<%=conc_6%>" maxlength="25" size="25" name="conc_6"> &nbsp;Etiquetado
06&nbsp;<input value="<%=eti_conc_6%>" maxlength="50" size="35" name="eti_conc_6"><br>Concentraci&oacute;n 07&nbsp;<input value="<%=conc_7%>" maxlength="25" size="25" name="conc_7"> &nbsp;Etiquetado
07&nbsp;<input value="<%=eti_conc_7%>" maxlength="50" size="35" name="eti_conc_7"><br>Concentraci&oacute;n 08&nbsp;<input value="<%=conc_8%>" maxlength="25" size="25" name="conc_8"> &nbsp;Etiquetado
08&nbsp;<input value="<%=eti_conc_8%>" maxlength="50" size="35" name="eti_conc_8"><br>Concentraci&oacute;n 09&nbsp;<input value="<%=conc_9%>" maxlength="25" size="25" name="conc_9"> &nbsp;Etiquetado
09&nbsp;<input value="<%=eti_conc_9%>" maxlength="50" size="35" name="eti_conc_9"><br>Concentraci&oacute;n 10 <input value="<%=conc_10%>" maxlength="25" size="25" name="conc_10"> &nbsp;Etiquetado 10 <input value="<%=eti_conc_10%>" maxlength="50" size="35" name="eti_conc_10"><br>Concentraci&oacute;n 11 <input value="<%=conc_11%>" maxlength="25" size="25" name="conc_11"> &nbsp;Etiquetado 11 <input value="<%=eti_conc_11%>" maxlength="50" size="35" name="eti_conc_11"><br>Concentraci&oacute;n&nbsp;12 <input value="<%=conc_12%>" maxlength="25" size="25" name="conc_12"> &nbsp;Etiquetado 12 <input value="<%=eti_conc_12%>" maxlength="50" size="35" name="eti_conc_12"><br>Concentraci&oacute;n 13 <input value="<%=conc_13%>" maxlength="25" size="25" name="conc_13"> &nbsp;Etiquetado 13 <input value="<%=eti_conc_13%>" maxlength="50" size="35" name="eti_conc_13"><br>Concentraci&oacute;n 14 <input value="<%=conc_14%>" maxlength="25" size="25" name="conc_14"> &nbsp;Etiquetado 14 <input value="<%=eti_conc_14%>" maxlength="50" size="35" name="eti_conc_14"><br>Concentraci&oacute;n 15 <input value="<%=conc_15%>" maxlength="25" size="25" name="conc_15"> &nbsp;Etiquetado 15 <input value="<%=eti_conc_15%>" maxlength="50" size="35" name="eti_conc_15"><br>  <br class="exp">  <span class="exp">(concentraciones,
max 25 c cada; etiquetas, m&aacute;x 50 c cada)</span><br>  </fieldset>
  </fieldset>
...
frmvalidator.addValidation("nombre","maxlen=750");
frmvalidator.addValidation("nombre_ing","maxlen=750");
...
frmvalidator.addValidation("conc_1","maxlen=25");
frmvalidator.addValidation("conc_2","maxlen=25");
frmvalidator.addValidation("conc_3","maxlen=25");
frmvalidator.addValidation("conc_4","maxlen=25");
frmvalidator.addValidation("conc_5","maxlen=25");
frmvalidator.addValidation("conc_6","maxlen=25");
frmvalidator.addValidation("conc_7","maxlen=25");
frmvalidator.addValidation("conc_8","maxlen=25");
frmvalidator.addValidation("conc_9","maxlen=25");
frmvalidator.addValidation("conc_10","maxlen=25");
frmvalidator.addValidation("conc_11","maxlen=25");
frmvalidator.addValidation("conc_12","maxlen=25");
frmvalidator.addValidation("conc_13","maxlen=25");
frmvalidator.addValidation("conc_14","maxlen=25");
frmvalidator.addValidation("conc_15","maxlen=25");
frmvalidator.addValidation("eti_conc_1","maxlen=50");
frmvalidator.addValidation("eti_conc_2","maxlen=50");
frmvalidator.addValidation("eti_conc_3","maxlen=50");
frmvalidator.addValidation("eti_conc_4","maxlen=50");
frmvalidator.addValidation("eti_conc_5","maxlen=50");
frmvalidator.addValidation("eti_conc_6","maxlen=50");
frmvalidator.addValidation("eti_conc_7","maxlen=50");
frmvalidator.addValidation("eti_conc_8","maxlen=50");
frmvalidator.addValidation("eti_conc_9","maxlen=50");
frmvalidator.addValidation("eti_conc_10","maxlen=50");
frmvalidator.addValidation("eti_conc_11","maxlen=50");
frmvalidator.addValidation("eti_conc_12","maxlen=50");
frmvalidator.addValidation("eti_conc_13","maxlen=50");
frmvalidator.addValidation("eti_conc_14","maxlen=50");
