	...
	<fieldset>
 		...
 		<fieldset>
            ...
            -->
			 ...
			 <span style="color: red">Ojo, deben coincidir el número de fuentes con el de categorías seleccionadas. De no ser así la ficha no se verá bien.</span>
		 </fieldset>
		<fieldset>
...
<fieldset>
  ...
  <tr><td>Nombre sustancia TPB</td><td><input name="t5_anchor_tpb" type="text" value="<%=anchor_tpb%>" size="100" maxlength="750" /></td></tr>
  <%
...
<fieldset>
<legend><strong>Muy Persistente y Muy Bioacumulativa (mPmB)</strong></legend>
	<input type="checkbox" value="1"  name="t5_mPmB" <%=dimechecked(mpmb)%> /> mPmB
</fieldset>
