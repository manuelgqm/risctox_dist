        ...
        case "minlen": 
           { 
             ...
             { 
               if(!strError || strError.length ==0) 
               { 
                 strError = objValue.name + " : " + cmdvalue + " caractéres mínimo  "; 
               }//if               
               alert(strError + "\n[Longitud actual = " + objValue.value.length + " ]"); 
               return false;                 
             }//if 
           ...
           { 
              ...
              { 
               if(!strError || strError.length ==0) 
                ...
                alert(strError + "\n [Error en el caracter con posición " + eval(charpos+1)+"]"); 
                return false; 
              }//if 
              break; 
           }//case alphanumeric 
        ...
        case "numeric": 
           { 
              ...
              { 
                if(!strError || strError.length ==0) 
                { 
                  strError = objValue.name+": Sólo se admiten dígitos "; 
                }//if               
                alert(strError + "\n [Error en el caracter con posición " + eval(charpos+1)+"]"); 
                return false; 
              }//if 
        ...
        case "alpha": 
           { 
              ...
              { 
                  if(!strError || strError.length ==0) 
                { 
                  strError = objValue.name+": Sólo se admiten letras "; 
                }//if                             
                alert(strError + "\n [Error en el caracter con posición  " + eval(charpos+1)+"]"); 
                return false; 
              }//if 
        ...
        case "email": 
          { 
               ...
               { 
                 if(!strError || strError.length ==0) 
                 { 
                    strError = objValue.name+": el email no es válido "; 
                 }//if                                               
                 alert(strError); 
                 return false; 
               }//if 
         ...
         { 
		 	if(objValue.value.length > 0)
			{
	            ...
	            { 
	              if(!strError || strError.length ==0) 
	              { 
	                strError = objValue.name+": se han encontrado caracteres no válidos "; 
	              }//if                                                               
	              alert(strError); 
	              return false;                   
	            }//if 
