		...
		'response.write sqls
			...
			if hr>0 then
				for contadorFilas=0 to hr-1
						  ...
						  tablares=tablares & "<td><a href='#' onclick=" &chr(34)& "abreVentanaCentrada('dn_asociaciones_mostrar.asp?tipo=grupo&id=" &arrayDatos(0,contadorFilas)& "', 800, 580); return false;" &chr(34)& "	><img src='imagenes/relacion.png' align='left' alt='Ver relación' /></a>&nbsp;" &arrayDatos(1,contadorFilas)& "<br/><blockquote><i>"&nl2br(arrayDatos(3,contadorFilas))&"</i></blockquote></td>"
				...
				tablares="<table id='resultados' cellspacing='0' cellpadding='3' border='1' align='center'><tr><th><input type='checkbox' name='selector' onchange='cambiachecks(this)' /></th><th>Nº</th><th>NOMBRE</th><th>NOMBRE EN INGL&Eacute;S</th><th>Modificar</th><th>Ver/Modificar<br />Sustancias asociadas</th><th>Asociar<br />en bloque</th></tr>" &tablares& "</table>"
			end if
...
%>
		...
		La acción sobre la que pulse se llevará a cabo sobre los grupos marcados
