...
01&nbsp;<input value="<%=eti_conc_1%>" maxlength="100" size="35" name="eti_conc_1"><br>Concentraci&oacute;n 02&nbsp;<input value="<%=conc_2%>" maxlength="25" size="25" name="conc_2"> &nbsp;Etiquetado
02&nbsp;<input value="<%=eti_conc_2%>" maxlength="100" size="35" name="eti_conc_2"><br>Concentraci&oacute;n 03&nbsp;<input value="<%=conc_3%>" maxlength="25" size="25" name="conc_3"> &nbsp;Etiquetado
03&nbsp;<input value="<%=eti_conc_3%>" maxlength="100" size="35" name="eti_conc_3"><br>Concentraci&oacute;n 04&nbsp;<input value="<%=conc_4%>" maxlength="25" size="25" name="conc_4"> &nbsp;Etiquetado
04&nbsp;<input value="<%=eti_conc_4%>" maxlength="100" size="35" name="eti_conc_4"><br>Concentraci&oacute;n 05&nbsp;<input value="<%=conc_5%>" maxlength="25" size="25" name="conc_5"> &nbsp;Etiquetado
05&nbsp;<input value="<%=eti_conc_5%>" maxlength="100" size="35" name="eti_conc_5"><br>Concentraci&oacute;n 06&nbsp;<input value="<%=conc_6%>" maxlength="25" size="25" name="conc_6"> &nbsp;Etiquetado
06&nbsp;<input value="<%=eti_conc_6%>" maxlength="100" size="35" name="eti_conc_6"><br>Concentraci&oacute;n 07&nbsp;<input value="<%=conc_7%>" maxlength="25" size="25" name="conc_7"> &nbsp;Etiquetado
07&nbsp;<input value="<%=eti_conc_7%>" maxlength="100" size="35" name="eti_conc_7"><br>Concentraci&oacute;n 08&nbsp;<input value="<%=conc_8%>" maxlength="25" size="25" name="conc_8"> &nbsp;Etiquetado
08&nbsp;<input value="<%=eti_conc_8%>" maxlength="100" size="35" name="eti_conc_8"><br>Concentraci&oacute;n 09&nbsp;<input value="<%=conc_9%>" maxlength="25" size="25" name="conc_9"> &nbsp;Etiquetado
09&nbsp;<input value="<%=eti_conc_9%>" maxlength="100" size="35" name="eti_conc_9"><br>Concentraci&oacute;n 10 <input value="<%=conc_10%>" maxlength="25" size="25" name="conc_10"> &nbsp;Etiquetado 10 <input value="<%=eti_conc_10%>" maxlength="100" size="35" name="eti_conc_10"><br>Concentraci&oacute;n 11 <input value="<%=conc_11%>" maxlength="25" size="25" name="conc_11"> &nbsp;Etiquetado 11 <input value="<%=eti_conc_11%>" maxlength="100" size="35" name="eti_conc_11"><br>Concentraci&oacute;n&nbsp;12 <input value="<%=conc_12%>" maxlength="25" size="25" name="conc_12"> &nbsp;Etiquetado 12 <input value="<%=eti_conc_12%>" maxlength="100" size="35" name="eti_conc_12"><br>Concentraci&oacute;n 13 <input value="<%=conc_13%>" maxlength="25" size="25" name="conc_13"> &nbsp;Etiquetado 13 <input value="<%=eti_conc_13%>" maxlength="100" size="35" name="eti_conc_13"><br>Concentraci&oacute;n 14 <input value="<%=conc_14%>" maxlength="25" size="25" name="conc_14"> &nbsp;Etiquetado 14 <input value="<%=eti_conc_14%>" maxlength="100" size="35" name="eti_conc_14"><br>Concentraci&oacute;n 15 <input value="<%=conc_15%>" maxlength="25" size="25" name="conc_15"> &nbsp;Etiquetado 15 <input value="<%=eti_conc_15%>" maxlength="100" size="35" name="eti_conc_15"><br>  <br class="exp">  <span class="exp">(concentraciones,
max 25 c cada; etiquetas, m&aacute;x 50 c cada)</span><br>
</fieldset>
  </fieldset>
...
frmvalidator.addValidation("eti_conc_1","maxlen=100");
frmvalidator.addValidation("eti_conc_2","maxlen=100");
frmvalidator.addValidation("eti_conc_3","maxlen=100");
frmvalidator.addValidation("eti_conc_4","maxlen=100");
frmvalidator.addValidation("eti_conc_5","maxlen=100");
frmvalidator.addValidation("eti_conc_6","maxlen=100");
frmvalidator.addValidation("eti_conc_7","maxlen=100");
frmvalidator.addValidation("eti_conc_8","maxlen=100");
frmvalidator.addValidation("eti_conc_9","maxlen=100");
frmvalidator.addValidation("eti_conc_10","maxlen=100");
frmvalidator.addValidation("eti_conc_11","maxlen=100");
frmvalidator.addValidation("eti_conc_12","maxlen=100");
frmvalidator.addValidation("eti_conc_13","maxlen=100");
frmvalidator.addValidation("eti_conc_14","maxlen=100");
frmvalidator.addValidation("eti_conc_15","maxlen=100");
