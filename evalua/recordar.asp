...
<%	
	...
	texto2 = "Gracias por tu interés en la protección del medio ambiente.<br>* Te recordamos que puedes darte de baja como usuario de ECOinformas en cualquier momento. Para más información: <a href='mailto:datospersonales@istas.net'>datos personales</a>."
		...
		cuerpo = cuerpo & "<p class=texto align=left>Con la siguiente clave y contraseña , tendrá acceso libre a toda la página web y podrá aprovechar los servicios y productos gratuitos que le ofrecemos.</p>" & chr(13)
		...
		cuerpo = cuerpo & "<p class=texto align=left>En la herramienta <a href='http://www.istas.net/risctox/evalua/'><b>Evalúa lo que usas</b></a> podrá conocer el riego que presentan los productos que utiliza en su empresa y compararlos con posibles alternativas.</p>"
		...
		if email<>"" then
			...
			Mail.FromName = "ISTAS: Riesgo químico: Evalua lo que usas" ' Opcional 
