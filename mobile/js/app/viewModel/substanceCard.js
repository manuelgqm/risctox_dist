	...
	module = {
		run: function(){
			var substanceCard = 
				...
				, hasEinecs: function()
					{ return this.num_ce_einecs && !beginsWithChar(this.num_ce_einecs, 4) && !this.num_ce_elincs }
				, hasElincs: function()
					{ return this.num_ce_elincs && (beginsWithChar(this.num_ce_einecs, 4) || !this.num_ce_einecs) }
				, hasVlbIb: function()
