...
<p class=titulo3>RISCTOX: L&iacute;mites de exposici&oacute;n profesional: Valores L&iacute;mite Biol&oacute;gicos</p>


<form action="dn_risctox_vl3.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
...
<tr>
  <td colspan="3" class="subtitulo3">Buscador</td></td></tr>
	...
	<tr>
		<td colspan="2" align="center"><input type="button" class="boton" value="Buscar" onClick="primerapag();" /> <input class="boton" type="reset" value="Borrar" /></td>
	</tr>
</table>
