...
<meta name="Author" content="SPL Sistemas de Informacion - www.spl-ssi.com" />
...
<p class=titulo3>RISCTOX: Sustancias sujetas a autorización de REACH</p>


<form action="spl_risctox_autorizacion_reach.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
