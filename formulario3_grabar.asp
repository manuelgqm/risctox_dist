...
if (EliminaInyeccionSQL(request(campo(49,0)))="1") or (EliminaInyeccionSQL(request(campo(50,0)))="1") or (EliminaInyeccionSQL(request(campo(51,0)))="1") or (EliminaInyeccionSQL(request(campo(52,0)))="1") or (EliminaInyeccionSQL(request(campo(53,0)))="1") or (EliminaInyeccionSQL(request(campo(54,0)))="1") or (EliminaInyeccionSQL(request(campo(55,0)))="1") or (EliminaInyeccionSQL(request(campo(56,0)))="1") or (EliminaInyeccionSQL(request(campo(57,0)))="1") or (EliminaInyeccionSQL(request(campo(58,0)))="1") or (EliminaInyeccionSQL(request(campo(59,0)))="1") or (EliminaInyeccionSQL(request(campo(60,0)))="1") or (EliminaInyeccionSQL(request(campo(61,0)))="1") or (EliminaInyeccionSQL(request(campo(62,0)))="1") or (EliminaInyeccionSQL(request(campo(63,0)))="1") or (EliminaInyeccionSQL(request(campo(64,0)))="1") or (EliminaInyeccionSQL(request(campo(65,0)))="1") then
	...
	texto2 = "Gracias por tu interés en la protección del medio ambiente.<br>* Te recordamos que puedes darte de baja como usuario de ECOinformas en cualquier momento. Para más información: <a href='mailto:datospersonales@istas.net'>datos personales</a>."
		...
		cuerpo = cuerpo & "<p class=texto><center>Clave: <b>"&clave&"</b><br>Contraseña: <b>"&contra&"</b></center></p>" & chr(13)
		...
		if EliminaInyeccionSQL(request("email"))<>"" then
			email_dest = request("email")
			Set Mail = Server.CreateObject("Persits.MailSender")
			Mail.Host = "smtp.istas.net"
			Mail.From = "boletin@istas.net"
  	...
  	<div id="sombra_lateral">
		<div id="caja">
			...
			<div id="texto">
				...
				CLAVE:&nbsp;<b><%=clave%></b><br>CONTRASEÑA:&nbsp;<b><%=contra%></b><br><br>Te hemos enviado un email con la clave y contraseña a la dirección <i><%=EliminaInyeccionSQL(request("email"))%></i><br><br>
				<%=texto1%></td></tr>
