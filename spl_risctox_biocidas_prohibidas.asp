...
<p class=titulo3>RISCTOX: Sustancias biocidas prohibidas</p>


<form action="spl_risctox_biocidas_prohibidas.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
