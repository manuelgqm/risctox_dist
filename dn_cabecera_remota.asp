...
%>
            ...
            <div class="textsubmenu" id="submenusup3">
            	<table cellspacing=1 cellpadding=1 border=0 style='padding:3px'>
            	<%
                if (Instr(request.servervariables("PATH_INFO"),"/evalua/") > 0 or idpagina=1175 or idpagina=961) then
					response.write "<td style='padding:5px'><a href='http://www.istas.net/risctox/'>bbdd risctox</a></td>"
					response.write "<td>|</td>"
					response.write "<td style='padding:5px'><a href='http://www.istas.net/risctox/alternativas/'>bbdd alternativas</a></td>"	
					response.write "<td>|</td>"				
					response.write "<td bgcolor='#FFFFFF' style='padding:5px'>evalúa lo que usas</td>"
				elseif (Instr(request.servervariables("PATH_INFO"),"/alternativas/") > 0 or idpagina=576 or idpagina=1174 ) then
					response.write "<td style='padding:5px'><a href='http://www.istas.net/risctox/'>bbdd risctox</a></td>"
					response.write "<td>|</td>"
					response.write "<td bgcolor='#FFFFFF' style='padding:5px'>bbdd alternativas</td>"	
					response.write "<td >|</td>"				
					response.write "<td style='padding:5px'><a href='http://www.istas.net/risctox/evalua/'>evalúa lo que usas</a></td>"
				else
