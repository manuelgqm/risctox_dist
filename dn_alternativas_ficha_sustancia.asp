...
<tr>
<td><p class=campo>Est&aacute;s en: <a href=index.asp?idpagina=550>Plataforma prevención de riesgo químico</a>&nbsp;&gt;&nbsp;<a href="dn_alternativas_portada.asp">BBDD Alternativas</a>&nbsp;&gt;&nbsp;Ficha de sustancia</p></td>
...
%>
	...
	<table width="100%" class="tabla3">
		<tr>
			...
			<td class="texto">
				<b><a href="dn_risctox_ficha_sustancia.asp?id_sustancia=<%=id_sustancia%>" title="Ver ficha en Risctox" /><%=espaciar(nombre)%></a></b>
			</td>
		</tr>
		<%
		if (sinonimos<>"") then
