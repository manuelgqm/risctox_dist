...
<p class=titulo3>Buscador de Alternativas </p>
	<center><input type="button" value="Sustancias no peligrosas según Anexo IV REACH" onclick="location.href='./dn_alternativas_anexo_reach.asp'" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt;	font-weight: normal; color: #006600;	text-align: center; cursor: pointer;" /></center>
