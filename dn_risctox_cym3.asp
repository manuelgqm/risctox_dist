...
<p class=titulo3>RISCTOX: Sustancias cancer&iacute;genas o mut&aacute;genas (seg&uacute;n otras fuentes)</p>


<form action="dn_risctox_cym3.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
...
<tr>
  <td colspan="3" class="subtitulo3">Buscador</td></td></tr>
	...
	<tr>
		<td colspan="2" align="center"><input type="submit" value="Buscar" class="boton" /> <input type="reset" value="Borrar" class="boton" /></td>
	</tr>
</table>
