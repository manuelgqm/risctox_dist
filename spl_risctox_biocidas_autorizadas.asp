...
<p class=titulo3>RISCTOX: Sustancias biocidas autorizadas</p>


<form action="spl_risctox_biocidas_autorizadas.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
