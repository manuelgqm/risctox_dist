...
<p class=titulo3>RISCTOX: Sustancias neurot&oacute;xicas</p>


<form action="dn_risctox_neu.asp?busc=1" method="post" name="myform" onSubmit="primerapag();">
...
<tr>
  <td colspan="3" class="subtitulo3">Buscador de sustancias neurot&oacute;xicas </td></td></tr>
	<tr>
	...
	<tr>
		<td colspan="2" align="center"><input type="button" value="Buscar" class="boton" onClick="primerapag();" /> <input type="reset" class="boton" value="Borrar" /></td>
	</tr>
</table>
