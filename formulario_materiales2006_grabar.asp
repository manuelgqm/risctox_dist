...
<%
	...
	campo(3,0)="provincia" 
	campo(4,0)="cp" 
	campo(5,0)="EGP01_2006"   
	campo(6,0)="AE01_2006"   
	campo(7,0)="AE02_2006"   
	campo(8,0)="AE03_2006"   
	campo(9,0)="AE04_2006"   
	campo(10,0)="AE05_2006"   
	campo(11,0)="direccion_materiales"   
	campo(12,0)="comentarios_2006" 
	campo(13,0)="cdrom"   
	
	campo(1,1)=unquote(EliminaInyeccionSQL(request(campo(1,0))))
	campo(2,1)=unquote(EliminaInyeccionSQL(request(campo(2,0))))
	campo(3,1)=request(campo(3,0))
	...
	campo(11,1)=EliminaInyeccionSQL(request(campo(11,0)))
	campo(12,1)=unquote(mid(EliminaInyeccionSQL(request(campo(12,0))),1,1000))
	campo(13,1)=EliminaInyeccionSQL(request("cdrom"))
...
<tr>
	...
	<td class=texto align=left><input type="text" name="cp" size="50" maxlength="200" class="campo" value="<%=valor(EliminaInyeccionSQL(request(campo(11,0)))) %>"></td>
</tr>
<tr>
	<td class=texto align=right valign="middle">Anotación:</td>
	<td class=texto align=left><textarea name="comentarios_2006" cols="48" rows="3" class="campo"><%=unquote(EliminaInyeccionSQL(request(campo(12,0)))) %></textarea></td>
</tr>
</table>
<br>&nbsp;
<table cellspacing=0 border=0 cellpadding=5 class=tabla width="95%" align="center">
...
<tr><td class="celda"><input type="checkbox" name="cdrom" value="1" class="campo" <% if campo(13,1)="1" then response.write "checked" %>>&nbsp;</td><td class="celda">CD-ROM</td><td class="celda">"acTÚa en tu empresa", CD-ROM interactivo para la mejora ambiental de las PyMES</td></tr>
<tr><td class="celda"><input type="checkbox" name="EGP01_2006" value="1" class="campo" <% if campo(5,1)="1" then response.write "checked" %>>&nbsp;</td><td class="celda">EGP01</td><td class="celda">La participación de los trabajadores en la protección del medio ambiente en el centro de trabajo</td></tr>
<tr><td class="celda"><input type="checkbox" name="AE01_2006" value="1" class="campo" <% if campo(6,1)="1" then response.write "checked" %>>&nbsp;</td><td class="celda">AE01</td><td class="celda">Afectación y cumplimiento de la normativa Seveso en la industria española</td></tr>
<tr><td class="celda"><input type="checkbox" name="AE02_2006" value="1" class="campo" <% if campo(7,1)="1" then response.write "checked" %>>&nbsp;</td><td class="celda">AE02</td><td class="celda">Estudio sobre la participación de los trabajadores en el proceso de la Autorización Ambiental Integrada</td></tr>
<tr><td class="celda"><input type="checkbox" name="AE03_2006" value="1" class="campo" <% if campo(8,1)="1" then response.write "checked" %>>&nbsp;</td><td class="celda">AE03</td><td class="celda">Incendios forestales: impacto sobre el medio ambiente, la economía y el empleo</td></tr>
<tr><td class="celda"><input type="checkbox" name="AE04_2006" value="1" class="campo" <% if campo(9,1)="1" then response.write "checked" %>>&nbsp;</td><td class="celda">AE04</td><td class="celda">Estudio del empleo en PyME en el sector de las energías renovables en España</td></tr>
<tr><td class="celda"><input type="checkbox" name="AE05_2006" value="1" class="campo" <% if campo(10,1)="1" then response.write "checked" %>>&nbsp;</td><td class="celda">AE05</td><td class="celda">Estudio sobre la generación y minimización de residuos en el ámbito de las PyMEs</td></tr>
</table>
